...
public class EDAMUserException extends Exception implements TBase<EDAMUserException>,
	...
	private static final TField ERROR_CODE_FIELD_DESC = new TField("errorCode", TType.I32,
			(short) 1);
	private static final TField PARAMETER_FIELD_DESC = new TField("parameter", TType.STRING,
			(short) 2);
	...
	public int compareTo(EDAMUserException other) {
		...
		EDAMUserException typedOther = other;
		...
		if (isSetParameter()) {
			lastComparison = TBaseHelper.compareTo(this.parameter, typedOther.parameter);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
