...
public class EDAMSystemException extends Exception implements TBase<EDAMSystemException>,
	...
	private static final TField ERROR_CODE_FIELD_DESC = new TField("errorCode", TType.I32,
			(short) 1);
	private static final TField MESSAGE_FIELD_DESC = new TField("message", TType.STRING, (short) 2);
	private static final TField RATE_LIMIT_DURATION_FIELD_DESC = new TField("rateLimitDuration",
			TType.I32, (short) 3);
	...
	public int compareTo(EDAMSystemException other) {
		...
		EDAMSystemException typedOther = other;
		...
		lastComparison = Boolean.valueOf(isSetRateLimitDuration()).compareTo(
				typedOther.isSetRateLimitDuration());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetRateLimitDuration()) {
			lastComparison = TBaseHelper.compareTo(this.rateLimitDuration,
					typedOther.rateLimitDuration);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws TException {
		...
		if (!isSetErrorCode()) {
			throw new TProtocolException("Required field 'errorCode' is unset! Struct:"
					+ toString());
		}
