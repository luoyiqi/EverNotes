...
public class ClientUsageMetrics implements TBase<ClientUsageMetrics>, java.io.Serializable,
		Cloneable {
	...
	public int compareTo(ClientUsageMetrics other) {
		...
		ClientUsageMetrics typedOther = other;
		...
		if (isSetSessions()) {
			lastComparison = TBaseHelper.compareTo(this.sessions, typedOther.sessions);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
