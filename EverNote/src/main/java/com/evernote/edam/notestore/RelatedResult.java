...
public class RelatedResult implements TBase<RelatedResult>, java.io.Serializable, Cloneable {
	...
	private static final TField CONTAINING_NOTEBOOKS_FIELD_DESC = new TField("containingNotebooks",
			TType.LIST, (short) 4);
	...
	public RelatedResult(RelatedResult other) {
		...
		if (other.isSetContainingNotebooks()) {
			...
			for (com.evernote.edam.type.NotebookDescriptor other_element : other.containingNotebooks) {
				__this__containingNotebooks.add(new com.evernote.edam.type.NotebookDescriptor(
						other_element));
			}
	...
	public void setContainingNotebooks(
			List<com.evernote.edam.type.NotebookDescriptor> containingNotebooks) {
	...
	public int compareTo(RelatedResult other) {
		...
		RelatedResult typedOther = other;
		...
		lastComparison = Boolean.valueOf(isSetContainingNotebooks()).compareTo(
				typedOther.isSetContainingNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetContainingNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.containingNotebooks,
					typedOther.containingNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
