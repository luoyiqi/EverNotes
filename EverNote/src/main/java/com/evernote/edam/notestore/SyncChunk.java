...
public class SyncChunk implements TBase<SyncChunk>, java.io.Serializable, Cloneable {
	...
	private static final TField CURRENT_TIME_FIELD_DESC = new TField("currentTime", TType.I64,
			(short) 1);
	private static final TField CHUNK_HIGH_USN_FIELD_DESC = new TField("chunkHighUSN", TType.I32,
			(short) 2);
	private static final TField UPDATE_COUNT_FIELD_DESC = new TField("updateCount", TType.I32,
			(short) 3);
	private static final TField NOTES_FIELD_DESC = new TField("notes", TType.LIST, (short) 4);
	private static final TField NOTEBOOKS_FIELD_DESC = new TField("notebooks", TType.LIST,
			(short) 5);
	...
	private static final TField RESOURCES_FIELD_DESC = new TField("resources", TType.LIST,
			(short) 8);
	private static final TField EXPUNGED_NOTES_FIELD_DESC = new TField("expungedNotes", TType.LIST,
			(short) 9);
	private static final TField EXPUNGED_NOTEBOOKS_FIELD_DESC = new TField("expungedNotebooks",
			TType.LIST, (short) 10);
	private static final TField EXPUNGED_TAGS_FIELD_DESC = new TField("expungedTags", TType.LIST,
			(short) 11);
	private static final TField EXPUNGED_SEARCHES_FIELD_DESC = new TField("expungedSearches",
			TType.LIST, (short) 12);
	private static final TField LINKED_NOTEBOOKS_FIELD_DESC = new TField("linkedNotebooks",
			TType.LIST, (short) 13);
	private static final TField EXPUNGED_LINKED_NOTEBOOKS_FIELD_DESC = new TField(
			"expungedLinkedNotebooks", TType.LIST, (short) 14);
	...
	public SyncChunk(long currentTime, int updateCount) {
		this();
	...
	public SyncChunk(SyncChunk other) {
		...
		if (other.isSetLinkedNotebooks()) {
			...
			for (com.evernote.edam.type.LinkedNotebook other_element : other.linkedNotebooks) {
				__this__linkedNotebooks
						.add(new com.evernote.edam.type.LinkedNotebook(other_element));
			}
	...
	public java.util.Iterator<String> getExpungedLinkedNotebooksIterator() {
		return (this.expungedLinkedNotebooks == null) ? null : this.expungedLinkedNotebooks
				.iterator();
	}
	...
	public int compareTo(SyncChunk other) {
		...
		lastComparison = Boolean.valueOf(isSetChunkHighUSN()).compareTo(
				typedOther.isSetChunkHighUSN());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetChunkHighUSN()) {
			lastComparison = TBaseHelper.compareTo(this.chunkHighUSN, typedOther.chunkHighUSN);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetUpdateCount()).compareTo(
				typedOther.isSetUpdateCount());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetUpdateCount()) {
		...
		if (isSetNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.notebooks, typedOther.notebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetSearches()) {
			lastComparison = TBaseHelper.compareTo(this.searches, typedOther.searches);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetResources()) {
			lastComparison = TBaseHelper.compareTo(this.resources, typedOther.resources);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetExpungedNotes()).compareTo(
				typedOther.isSetExpungedNotes());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetExpungedNotes()) {
			lastComparison = TBaseHelper.compareTo(this.expungedNotes, typedOther.expungedNotes);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetExpungedNotebooks()).compareTo(
				typedOther.isSetExpungedNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetExpungedNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.expungedNotebooks,
					typedOther.expungedNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetExpungedTags()).compareTo(
				typedOther.isSetExpungedTags());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetExpungedTags()) {
			lastComparison = TBaseHelper.compareTo(this.expungedTags, typedOther.expungedTags);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetExpungedSearches()).compareTo(
				typedOther.isSetExpungedSearches());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetExpungedSearches()) {
			lastComparison = TBaseHelper.compareTo(this.expungedSearches,
					typedOther.expungedSearches);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetLinkedNotebooks()).compareTo(
				typedOther.isSetLinkedNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLinkedNotebooks()) {
			lastComparison = TBaseHelper
					.compareTo(this.linkedNotebooks, typedOther.linkedNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetExpungedLinkedNotebooks()).compareTo(
				typedOther.isSetExpungedLinkedNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetExpungedLinkedNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.expungedLinkedNotebooks,
					typedOther.expungedLinkedNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void write(TProtocol oprot) throws TException {
		...
		if (this.expungedLinkedNotebooks != null) {
			if (isSetExpungedLinkedNotebooks()) {
				...
				{
					oprot.writeListBegin(new TList(TType.STRING, this.expungedLinkedNotebooks
							.size()));
	...
	public void validate() throws TException {
		...
		if (!isSetUpdateCount()) {
			throw new TProtocolException("Required field 'updateCount' is unset! Struct:"
					+ toString());
		}
