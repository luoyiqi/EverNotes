...
public class SyncState implements TBase<SyncState>, java.io.Serializable, Cloneable {
	...
	private static final TField CURRENT_TIME_FIELD_DESC = new TField("currentTime", TType.I64,
			(short) 1);
	private static final TField FULL_SYNC_BEFORE_FIELD_DESC = new TField("fullSyncBefore",
			TType.I64, (short) 2);
	...
	public int compareTo(SyncState other) {
		...
		lastComparison = Boolean.valueOf(isSetFullSyncBefore()).compareTo(
				typedOther.isSetFullSyncBefore());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetFullSyncBefore()) {
			lastComparison = TBaseHelper.compareTo(this.fullSyncBefore, typedOther.fullSyncBefore);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetUploaded()) {
			lastComparison = TBaseHelper.compareTo(this.uploaded, typedOther.uploaded);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws TException {
		...
		if (!isSetFullSyncBefore()) {
			throw new TProtocolException("Required field 'fullSyncBefore' is unset! Struct:"
					+ toString());
		}
