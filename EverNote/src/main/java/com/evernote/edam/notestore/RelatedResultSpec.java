...
public class RelatedResultSpec implements TBase<RelatedResultSpec>, java.io.Serializable, Cloneable {
	...
	private static final TField MAX_NOTEBOOKS_FIELD_DESC = new TField("maxNotebooks", TType.I32,
			(short) 2);
	private static final TField MAX_TAGS_FIELD_DESC = new TField("maxTags", TType.I32, (short) 3);
	private static final TField WRITABLE_NOTEBOOKS_ONLY_FIELD_DESC = new TField(
			"writableNotebooksOnly", TType.BOOL, (short) 4);
	private static final TField INCLUDE_CONTAINING_NOTEBOOKS_FIELD_DESC = new TField(
			"includeContainingNotebooks", TType.BOOL, (short) 5);
	...
	public boolean equals(RelatedResultSpec that) {
		...
		boolean this_present_includeContainingNotebooks = true && this
				.isSetIncludeContainingNotebooks();
		boolean that_present_includeContainingNotebooks = true && that
				.isSetIncludeContainingNotebooks();
	...
	public int compareTo(RelatedResultSpec other) {
		...
		RelatedResultSpec typedOther = other;
		...
		lastComparison = Boolean.valueOf(isSetMaxNotebooks()).compareTo(
				typedOther.isSetMaxNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetMaxNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.maxNotebooks, typedOther.maxNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetMaxTags()) {
			lastComparison = TBaseHelper.compareTo(this.maxTags, typedOther.maxTags);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetWritableNotebooksOnly()).compareTo(
				typedOther.isSetWritableNotebooksOnly());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetWritableNotebooksOnly()) {
			lastComparison = TBaseHelper.compareTo(this.writableNotebooksOnly,
					typedOther.writableNotebooksOnly);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetIncludeContainingNotebooks()).compareTo(
				typedOther.isSetIncludeContainingNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetIncludeContainingNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.includeContainingNotebooks,
					typedOther.includeContainingNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
