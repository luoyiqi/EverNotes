...
public class NoteMetadata implements TBase<NoteMetadata>, java.io.Serializable, Cloneable {
	...
	private static final TField CONTENT_LENGTH_FIELD_DESC = new TField("contentLength", TType.I32,
			(short) 5);
	...
	private static final TField NOTEBOOK_GUID_FIELD_DESC = new TField("notebookGuid", TType.STRING,
			(short) 11);
	private static final TField TAG_GUIDS_FIELD_DESC = new TField("tagGuids", TType.LIST,
			(short) 12);
	private static final TField ATTRIBUTES_FIELD_DESC = new TField("attributes", TType.STRUCT,
			(short) 14);
	private static final TField LARGEST_RESOURCE_MIME_FIELD_DESC = new TField(
			"largestResourceMime", TType.STRING, (short) 20);
	private static final TField LARGEST_RESOURCE_SIZE_FIELD_DESC = new TField(
			"largestResourceSize", TType.I32, (short) 21);
	...
	private final boolean[] __isset_vector = new boolean[6];

	public NoteMetadata() {
	}

	public NoteMetadata(String guid) {
		this();
		this.guid = guid;
	}
	...
	public int compareTo(NoteMetadata other) {
		...
		lastComparison = Boolean.valueOf(isSetContentLength()).compareTo(
				typedOther.isSetContentLength());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetContentLength()) {
			lastComparison = TBaseHelper.compareTo(this.contentLength, typedOther.contentLength);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetCreated()) {
			lastComparison = TBaseHelper.compareTo(this.created, typedOther.created);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetTagGuids()) {
			lastComparison = TBaseHelper.compareTo(this.tagGuids, typedOther.tagGuids);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetLargestResourceMime()).compareTo(
				typedOther.isSetLargestResourceMime());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLargestResourceMime()) {
			lastComparison = TBaseHelper.compareTo(this.largestResourceMime,
					typedOther.largestResourceMime);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetLargestResourceSize()).compareTo(
				typedOther.isSetLargestResourceSize());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLargestResourceSize()) {
			lastComparison = TBaseHelper.compareTo(this.largestResourceSize,
					typedOther.largestResourceSize);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
