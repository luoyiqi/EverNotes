...
public class NoteFilter implements TBase<NoteFilter>, java.io.Serializable, Cloneable {
	...
	private static final TField ASCENDING_FIELD_DESC = new TField("ascending", TType.BOOL,
			(short) 2);
	...
	private static final TField TIME_ZONE_FIELD_DESC = new TField("timeZone", TType.STRING,
			(short) 6);
	private static final TField INACTIVE_FIELD_DESC = new TField("inactive", TType.BOOL, (short) 7);
	private static final TField EMPHASIZED_FIELD_DESC = new TField("emphasized", TType.STRING,
			(short) 8);
	...
	public int compareTo(NoteFilter other) {
		...
		if (isSetAscending()) {
			lastComparison = TBaseHelper.compareTo(this.ascending, typedOther.ascending);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetWords()) {
			lastComparison = TBaseHelper.compareTo(this.words, typedOther.words);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetInactive()) {
			lastComparison = TBaseHelper.compareTo(this.inactive, typedOther.inactive);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetEmphasized()) {
			lastComparison = TBaseHelper.compareTo(this.emphasized, typedOther.emphasized);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
