...
public class NotesMetadataList implements TBase<NotesMetadataList>, java.io.Serializable, Cloneable {
	...
	private static final TField START_INDEX_FIELD_DESC = new TField("startIndex", TType.I32,
			(short) 1);
	private static final TField TOTAL_NOTES_FIELD_DESC = new TField("totalNotes", TType.I32,
			(short) 2);
	private static final TField NOTES_FIELD_DESC = new TField("notes", TType.LIST, (short) 3);
	private static final TField STOPPED_WORDS_FIELD_DESC = new TField("stoppedWords", TType.LIST,
			(short) 4);
	private static final TField SEARCHED_WORDS_FIELD_DESC = new TField("searchedWords", TType.LIST,
			(short) 5);
	...
	public NotesMetadataList(int startIndex, int totalNotes, List<NoteMetadata> notes) {
		this();
	...
	public int compareTo(NotesMetadataList other) {
		...
		NotesMetadataList typedOther = other;
		...
		lastComparison = Boolean.valueOf(isSetStoppedWords()).compareTo(
				typedOther.isSetStoppedWords());
		if (lastComparison != 0) {
			return lastComparison;
		}
		...
		lastComparison = Boolean.valueOf(isSetSearchedWords()).compareTo(
				typedOther.isSetSearchedWords());
		if (lastComparison != 0) {
			return lastComparison;
		}
	...
	public void validate() throws TException {
		...
		if (!isSetStartIndex()) {
			throw new TProtocolException("Required field 'startIndex' is unset! Struct:"
					+ toString());
		}

		if (!isSetTotalNotes()) {
			throw new TProtocolException("Required field 'totalNotes' is unset! Struct:"
					+ toString());
		}
