...
public class NoteVersionId implements TBase<NoteVersionId>, java.io.Serializable, Cloneable {
	...
	public NoteVersionId(int updateSequenceNum, long updated, long saved, String title) {
		this();
	...
	public int compareTo(NoteVersionId other) {
		...
		NoteVersionId typedOther = other;
		...
		if (isSetSaved()) {
			lastComparison = TBaseHelper.compareTo(this.saved, typedOther.saved);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws TException {
		...
		if (!isSetUpdateSequenceNum()) {
			throw new TProtocolException("Required field 'updateSequenceNum' is unset! Struct:"
					+ toString());
		}
