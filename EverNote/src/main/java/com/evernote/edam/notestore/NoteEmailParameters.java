...
public class NoteEmailParameters implements TBase<NoteEmailParameters>, java.io.Serializable,
		Cloneable {
	...
	private static final TField TO_ADDRESSES_FIELD_DESC = new TField("toAddresses", TType.LIST,
			(short) 3);
	private static final TField CC_ADDRESSES_FIELD_DESC = new TField("ccAddresses", TType.LIST,
			(short) 4);
	...
	public int compareTo(NoteEmailParameters other) {
		...
		NoteEmailParameters typedOther = other;
		...
		lastComparison = Boolean.valueOf(isSetToAddresses()).compareTo(
				typedOther.isSetToAddresses());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetToAddresses()) {
			lastComparison = TBaseHelper.compareTo(this.toAddresses, typedOther.toAddresses);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetCcAddresses()).compareTo(
				typedOther.isSetCcAddresses());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetCcAddresses()) {
			lastComparison = TBaseHelper.compareTo(this.ccAddresses, typedOther.ccAddresses);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
