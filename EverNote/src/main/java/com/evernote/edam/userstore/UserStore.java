...
public class UserStore {
	...
	public static class Client implements TServiceClient, Iface {
		...
		public boolean checkVersion(String clientName, short edamVersionMajor,
				short edamVersionMinor) throws TException {
			send_checkVersion(clientName, edamVersionMajor, edamVersionMinor);
			return recv_checkVersion();
		}

		public void send_checkVersion(String clientName, short edamVersionMajor,
				short edamVersionMinor) throws TException {
		...
		public boolean recv_checkVersion() throws TException {
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"checkVersion failed: out of sequence response");
			}
			...
			throw new TApplicationException(TApplicationException.MISSING_RESULT,
					"checkVersion failed: unknown result");
		}
		...
		public BootstrapInfo recv_getBootstrapInfo() throws TException {
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"getBootstrapInfo failed: out of sequence response");
			}
			...
			throw new TApplicationException(TApplicationException.MISSING_RESULT,
					"getBootstrapInfo failed: unknown result");
		}

		public AuthenticationResult authenticate(String username, String password,
				String consumerKey, String consumerSecret, boolean supportsTwoFactor)
		...
		public void send_authenticate(String username, String password, String consumerKey,
				String consumerSecret, boolean supportsTwoFactor) throws TException {
		...
		public AuthenticationResult recv_authenticate()
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"authenticate failed: out of sequence response");
			}
		...
		public AuthenticationResult authenticateLongSession(String username, String password,
				String consumerKey, String consumerSecret, String deviceIdentifier,
				String deviceDescription, boolean supportsTwoFactor)
				throws com.evernote.edam.error.EDAMUserException,
				com.evernote.edam.error.EDAMSystemException, TException {
			send_authenticateLongSession(username, password, consumerKey, consumerSecret,
					deviceIdentifier, deviceDescription, supportsTwoFactor);
			return recv_authenticateLongSession();
		}

		public void send_authenticateLongSession(String username, String password,
				String consumerKey, String consumerSecret, String deviceIdentifier,
				String deviceDescription, boolean supportsTwoFactor) throws TException {
			oprot_.writeMessageBegin(new TMessage("authenticateLongSession", TMessageType.CALL,
					++seqid_));
		...
		public AuthenticationResult recv_authenticateLongSession()
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"authenticateLongSession failed: out of sequence response");
			}
		...
		public AuthenticationResult completeTwoFactorAuthentication(String authenticationToken,
				String oneTimeCode, String deviceIdentifier, String deviceDescription)
				throws com.evernote.edam.error.EDAMUserException,
				com.evernote.edam.error.EDAMSystemException, TException {
			send_completeTwoFactorAuthentication(authenticationToken, oneTimeCode,
					deviceIdentifier, deviceDescription);
			return recv_completeTwoFactorAuthentication();
		}

		public void send_completeTwoFactorAuthentication(String authenticationToken,
				String oneTimeCode, String deviceIdentifier, String deviceDescription)
				throws TException {
			oprot_.writeMessageBegin(new TMessage("completeTwoFactorAuthentication",
		...
		public AuthenticationResult recv_completeTwoFactorAuthentication()
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"completeTwoFactorAuthentication failed: out of sequence response");
			}
		...
		public void recv_revokeLongSession() throws com.evernote.edam.error.EDAMUserException,
				com.evernote.edam.error.EDAMSystemException, TException {
			TMessage msg = iprot_.readMessageBegin();
			if (msg.type == TMessageType.EXCEPTION) {
				TApplicationException x = TApplicationException.read(iprot_);
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"revokeLongSession failed: out of sequence response");
			}
		...
		public void send_authenticateToBusiness(String authenticationToken) throws TException {
			oprot_.writeMessageBegin(new TMessage("authenticateToBusiness", TMessageType.CALL,
					++seqid_));
		...
		public AuthenticationResult recv_authenticateToBusiness()
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"authenticateToBusiness failed: out of sequence response");
			}
		...
		public void send_refreshAuthentication(String authenticationToken) throws TException {
			oprot_.writeMessageBegin(new TMessage("refreshAuthentication", TMessageType.CALL,
					++seqid_));
		...
		public AuthenticationResult recv_refreshAuthentication()
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"refreshAuthentication failed: out of sequence response");
			}
		...
		public com.evernote.edam.type.User getUser(String authenticationToken)
				throws com.evernote.edam.error.EDAMUserException,
				com.evernote.edam.error.EDAMSystemException, TException {
		...
		public com.evernote.edam.type.User recv_getUser()
				throws com.evernote.edam.error.EDAMUserException,
				com.evernote.edam.error.EDAMSystemException, TException {
			TMessage msg = iprot_.readMessageBegin();
			if (msg.type == TMessageType.EXCEPTION) {
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"getUser failed: out of sequence response");
			}
		...
		public PublicUserInfo getPublicUserInfo(String username)
				...
				com.evernote.edam.error.EDAMUserException, TException {
		...
		public PublicUserInfo recv_getPublicUserInfo()
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"getPublicUserInfo failed: out of sequence response");
			}
			...
			throw new TApplicationException(TApplicationException.MISSING_RESULT,
					"getPublicUserInfo failed: unknown result");
		}

		public com.evernote.edam.type.PremiumInfo getPremiumInfo(String authenticationToken)
				throws com.evernote.edam.error.EDAMUserException,
				com.evernote.edam.error.EDAMSystemException, TException {
		...
		public com.evernote.edam.type.PremiumInfo recv_getPremiumInfo()
				throws com.evernote.edam.error.EDAMUserException,
				com.evernote.edam.error.EDAMSystemException, TException {
			TMessage msg = iprot_.readMessageBegin();
			if (msg.type == TMessageType.EXCEPTION) {
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"getPremiumInfo failed: out of sequence response");
			}
			...
			throw new TApplicationException(TApplicationException.MISSING_RESULT,
					"getPremiumInfo failed: unknown result");
		}
		...
		public String recv_getNoteStoreUrl() throws com.evernote.edam.error.EDAMUserException,
				com.evernote.edam.error.EDAMSystemException, TException {
			TMessage msg = iprot_.readMessageBegin();
			if (msg.type == TMessageType.EXCEPTION) {
				TApplicationException x = TApplicationException.read(iprot_);
			...
			if (msg.seqid != seqid_) {
				throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
						"getNoteStoreUrl failed: out of sequence response");
			}
	...
	private static class checkVersion_args implements TBase<checkVersion_args>,
			java.io.Serializable, Cloneable {
		private static final TStruct STRUCT_DESC = new TStruct("checkVersion_args");

		private static final TField CLIENT_NAME_FIELD_DESC = new TField("clientName", TType.STRING,
				(short) 1);
		private static final TField EDAM_VERSION_MAJOR_FIELD_DESC = new TField("edamVersionMajor",
				TType.I16, (short) 2);
		private static final TField EDAM_VERSION_MINOR_FIELD_DESC = new TField("edamVersionMinor",
				TType.I16, (short) 3);
		...
		public int compareTo(checkVersion_args other) {
			...
			lastComparison = Boolean.valueOf(isSetClientName()).compareTo(
					typedOther.isSetClientName());
			if (lastComparison != 0) {
			...
			lastComparison = Boolean.valueOf(isSetEdamVersionMajor()).compareTo(
					typedOther.isSetEdamVersionMajor());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetEdamVersionMajor()) {
				lastComparison = TBaseHelper.compareTo(this.edamVersionMajor,
						typedOther.edamVersionMajor);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
			lastComparison = Boolean.valueOf(isSetEdamVersionMinor()).compareTo(
					typedOther.isSetEdamVersionMinor());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetEdamVersionMinor()) {
				lastComparison = TBaseHelper.compareTo(this.edamVersionMinor,
						typedOther.edamVersionMinor);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
	...
	private static class checkVersion_result implements TBase<checkVersion_result>,
			java.io.Serializable, Cloneable {
		private static final TStruct STRUCT_DESC = new TStruct("checkVersion_result");

		private static final TField SUCCESS_FIELD_DESC = new TField("success", TType.BOOL,
				(short) 0);
	...
	private static class getBootstrapInfo_args implements TBase<getBootstrapInfo_args>,
			java.io.Serializable, Cloneable {
		private static final TStruct STRUCT_DESC = new TStruct("getBootstrapInfo_args");

		private static final TField LOCALE_FIELD_DESC = new TField("locale", TType.STRING,
				(short) 1);
		...
		public int compareTo(getBootstrapInfo_args other) {
			...
			if (isSetLocale()) {
				lastComparison = TBaseHelper.compareTo(this.locale, typedOther.locale);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
	...
	private static class getBootstrapInfo_result implements TBase<getBootstrapInfo_result>,
			java.io.Serializable, Cloneable {
	...
	private static class authenticate_args implements TBase<authenticate_args>,
			java.io.Serializable, Cloneable {
		private static final TStruct STRUCT_DESC = new TStruct("authenticate_args");

		private static final TField USERNAME_FIELD_DESC = new TField("username", TType.STRING,
				(short) 1);
		private static final TField PASSWORD_FIELD_DESC = new TField("password", TType.STRING,
				(short) 2);
		private static final TField CONSUMER_KEY_FIELD_DESC = new TField("consumerKey",
				TType.STRING, (short) 3);
		private static final TField CONSUMER_SECRET_FIELD_DESC = new TField("consumerSecret",
				TType.STRING, (short) 4);
		private static final TField SUPPORTS_TWO_FACTOR_FIELD_DESC = new TField(
				"supportsTwoFactor", TType.BOOL, (short) 5);
		...
		public int compareTo(authenticate_args other) {
			...
			lastComparison = Boolean.valueOf(isSetConsumerKey()).compareTo(
					typedOther.isSetConsumerKey());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetConsumerKey()) {
				lastComparison = TBaseHelper.compareTo(this.consumerKey, typedOther.consumerKey);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
			lastComparison = Boolean.valueOf(isSetConsumerSecret()).compareTo(
					typedOther.isSetConsumerSecret());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetConsumerSecret()) {
				lastComparison = TBaseHelper.compareTo(this.consumerSecret,
						typedOther.consumerSecret);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
			lastComparison = Boolean.valueOf(isSetSupportsTwoFactor()).compareTo(
					typedOther.isSetSupportsTwoFactor());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetSupportsTwoFactor()) {
				lastComparison = TBaseHelper.compareTo(this.supportsTwoFactor,
						typedOther.supportsTwoFactor);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
	...
	private static class authenticate_result implements TBase<authenticate_result>,
			java.io.Serializable, Cloneable {
	...
	private static class authenticateLongSession_args implements
			TBase<authenticateLongSession_args>, java.io.Serializable, Cloneable {
		...
		private static final TField CONSUMER_SECRET_FIELD_DESC = new TField("consumerSecret",
				TType.STRING, (short) 4);
		private static final TField DEVICE_IDENTIFIER_FIELD_DESC = new TField("deviceIdentifier",
				TType.STRING, (short) 5);
		private static final TField DEVICE_DESCRIPTION_FIELD_DESC = new TField("deviceDescription",
				TType.STRING, (short) 6);
		private static final TField SUPPORTS_TWO_FACTOR_FIELD_DESC = new TField(
				"supportsTwoFactor", TType.BOOL, (short) 7);
		...
		public int compareTo(authenticateLongSession_args other) {
			...
			lastComparison = Boolean.valueOf(isSetDeviceIdentifier()).compareTo(
					typedOther.isSetDeviceIdentifier());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetDeviceIdentifier()) {
				lastComparison = TBaseHelper.compareTo(this.deviceIdentifier,
						typedOther.deviceIdentifier);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
			lastComparison = Boolean.valueOf(isSetDeviceDescription()).compareTo(
					typedOther.isSetDeviceDescription());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetDeviceDescription()) {
				lastComparison = TBaseHelper.compareTo(this.deviceDescription,
						typedOther.deviceDescription);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
	...
	private static class authenticateLongSession_result implements
			TBase<authenticateLongSession_result>, java.io.Serializable, Cloneable {
	...
	private static class completeTwoFactorAuthentication_args implements
			TBase<completeTwoFactorAuthentication_args>, java.io.Serializable, Cloneable {
		...
		private static final TField ONE_TIME_CODE_FIELD_DESC = new TField("oneTimeCode",
		...
		public int compareTo(completeTwoFactorAuthentication_args other) {
			...
			lastComparison = Boolean.valueOf(isSetOneTimeCode()).compareTo(
					typedOther.isSetOneTimeCode());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetOneTimeCode()) {
				lastComparison = TBaseHelper.compareTo(this.oneTimeCode, typedOther.oneTimeCode);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
	...
	private static class completeTwoFactorAuthentication_result implements
			TBase<completeTwoFactorAuthentication_result>, java.io.Serializable, Cloneable {
		private static final TStruct STRUCT_DESC = new TStruct(
				"completeTwoFactorAuthentication_result");
	...
	private static class revokeLongSession_args implements TBase<revokeLongSession_args>,
			java.io.Serializable, Cloneable {
	...
	private static class revokeLongSession_result implements TBase<revokeLongSession_result>,
			java.io.Serializable, Cloneable {
	...
	private static class authenticateToBusiness_args implements TBase<authenticateToBusiness_args>,
			java.io.Serializable, Cloneable {
	...
	private static class authenticateToBusiness_result implements
			TBase<authenticateToBusiness_result>, java.io.Serializable, Cloneable {
	...
	private static class refreshAuthentication_args implements TBase<refreshAuthentication_args>,
			java.io.Serializable, Cloneable {
	...
	private static class refreshAuthentication_result implements
			TBase<refreshAuthentication_result>, java.io.Serializable, Cloneable {
	...
	private static class getUser_args implements TBase<getUser_args>, java.io.Serializable,
			Cloneable {
	...
	private static class getUser_result implements TBase<getUser_result>, java.io.Serializable,
			Cloneable {
	...
	private static class getPublicUserInfo_args implements TBase<getPublicUserInfo_args>,
			java.io.Serializable, Cloneable {
	...
	private static class getPublicUserInfo_result implements TBase<getPublicUserInfo_result>,
			java.io.Serializable, Cloneable {
		...
		private static final TField NOT_FOUND_EXCEPTION_FIELD_DESC = new TField(
				"notFoundException", TType.STRUCT, (short) 1);
		private static final TField SYSTEM_EXCEPTION_FIELD_DESC = new TField("systemException",
				TType.STRUCT, (short) 2);
		private static final TField USER_EXCEPTION_FIELD_DESC = new TField("userException",
	...
	private static class getPremiumInfo_args implements TBase<getPremiumInfo_args>,
			java.io.Serializable, Cloneable {
	...
	private static class getPremiumInfo_result implements TBase<getPremiumInfo_result>,
			java.io.Serializable, Cloneable {
	...
	private static class getNoteStoreUrl_args implements TBase<getNoteStoreUrl_args>,
			java.io.Serializable, Cloneable {
	...
	private static class getNoteStoreUrl_result implements TBase<getNoteStoreUrl_result>,
			java.io.Serializable, Cloneable {
