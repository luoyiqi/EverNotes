...
public class BootstrapSettings implements TBase<BootstrapSettings>, java.io.Serializable, Cloneable {
	private static final TStruct STRUCT_DESC = new TStruct("BootstrapSettings");

	private static final TField SERVICE_HOST_FIELD_DESC = new TField("serviceHost", TType.STRING,
			(short) 1);
	private static final TField MARKETING_URL_FIELD_DESC = new TField("marketingUrl", TType.STRING,
			(short) 2);
	private static final TField SUPPORT_URL_FIELD_DESC = new TField("supportUrl", TType.STRING,
			(short) 3);
	private static final TField ACCOUNT_EMAIL_DOMAIN_FIELD_DESC = new TField("accountEmailDomain",
			TType.STRING, (short) 4);
	private static final TField ENABLE_FACEBOOK_SHARING_FIELD_DESC = new TField(
			"enableFacebookSharing", TType.BOOL, (short) 5);
	private static final TField ENABLE_GIFT_SUBSCRIPTIONS_FIELD_DESC = new TField(
			"enableGiftSubscriptions", TType.BOOL, (short) 6);
	private static final TField ENABLE_SUPPORT_TICKETS_FIELD_DESC = new TField(
			"enableSupportTickets", TType.BOOL, (short) 7);
	private static final TField ENABLE_SHARED_NOTEBOOKS_FIELD_DESC = new TField(
			"enableSharedNotebooks", TType.BOOL, (short) 8);
	private static final TField ENABLE_SINGLE_NOTE_SHARING_FIELD_DESC = new TField(
			"enableSingleNoteSharing", TType.BOOL, (short) 9);
	private static final TField ENABLE_SPONSORED_ACCOUNTS_FIELD_DESC = new TField(
			"enableSponsoredAccounts", TType.BOOL, (short) 10);
	private static final TField ENABLE_TWITTER_SHARING_FIELD_DESC = new TField(
			"enableTwitterSharing", TType.BOOL, (short) 11);
	private static final TField ENABLE_LINKED_IN_SHARING_FIELD_DESC = new TField(
			"enableLinkedInSharing", TType.BOOL, (short) 12);
	private static final TField ENABLE_PUBLIC_NOTEBOOKS_FIELD_DESC = new TField(
			"enablePublicNotebooks", TType.BOOL, (short) 13);
	...
	private final boolean[] __isset_vector = new boolean[9];

	public BootstrapSettings() {
	}

	public BootstrapSettings(String serviceHost, String marketingUrl, String supportUrl,
	...
	public BootstrapSettings(BootstrapSettings other) {
		...
		this.enablePublicNotebooks = other.enablePublicNotebooks;
	}
	...
	public void setEnablePublicNotebooks(boolean enablePublicNotebooks) {
		this.enablePublicNotebooks = enablePublicNotebooks;
		setEnablePublicNotebooksIsSet(true);
	}

	public void unsetEnablePublicNotebooks() {
		__isset_vector[__ENABLEPUBLICNOTEBOOKS_ISSET_ID] = false;
	}
	...
	public boolean isSetEnablePublicNotebooks() {
		return __isset_vector[__ENABLEPUBLICNOTEBOOKS_ISSET_ID];
	}

	public void setEnablePublicNotebooksIsSet(boolean value) {
		__isset_vector[__ENABLEPUBLICNOTEBOOKS_ISSET_ID] = value;
	}
	...
	public boolean equals(BootstrapSettings that) {
		...
		boolean this_present_enablePublicNotebooks = true && this.isSetEnablePublicNotebooks();
		boolean that_present_enablePublicNotebooks = true && that.isSetEnablePublicNotebooks();
		if (this_present_enablePublicNotebooks || that_present_enablePublicNotebooks) {
			if (!(this_present_enablePublicNotebooks && that_present_enablePublicNotebooks)) {
				return false;
			}
			if (this.enablePublicNotebooks != that.enablePublicNotebooks) {
				return false;
			}
		}
	...
	public int compareTo(BootstrapSettings other) {
		...
		BootstrapSettings typedOther = other;

		lastComparison = Boolean.valueOf(isSetServiceHost()).compareTo(
				typedOther.isSetServiceHost());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetServiceHost()) {
			lastComparison = TBaseHelper.compareTo(this.serviceHost, typedOther.serviceHost);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetMarketingUrl()).compareTo(
				typedOther.isSetMarketingUrl());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetMarketingUrl()) {
			lastComparison = TBaseHelper.compareTo(this.marketingUrl, typedOther.marketingUrl);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetSupportUrl()) {
			lastComparison = TBaseHelper.compareTo(this.supportUrl, typedOther.supportUrl);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetAccountEmailDomain()).compareTo(
				typedOther.isSetAccountEmailDomain());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetAccountEmailDomain()) {
			lastComparison = TBaseHelper.compareTo(this.accountEmailDomain,
					typedOther.accountEmailDomain);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnableFacebookSharing()).compareTo(
				typedOther.isSetEnableFacebookSharing());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnableFacebookSharing()) {
			lastComparison = TBaseHelper.compareTo(this.enableFacebookSharing,
					typedOther.enableFacebookSharing);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnableGiftSubscriptions()).compareTo(
				typedOther.isSetEnableGiftSubscriptions());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnableGiftSubscriptions()) {
			lastComparison = TBaseHelper.compareTo(this.enableGiftSubscriptions,
					typedOther.enableGiftSubscriptions);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnableSupportTickets()).compareTo(
				typedOther.isSetEnableSupportTickets());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnableSupportTickets()) {
			lastComparison = TBaseHelper.compareTo(this.enableSupportTickets,
					typedOther.enableSupportTickets);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnableSharedNotebooks()).compareTo(
				typedOther.isSetEnableSharedNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnableSharedNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.enableSharedNotebooks,
					typedOther.enableSharedNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnableSingleNoteSharing()).compareTo(
				typedOther.isSetEnableSingleNoteSharing());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnableSingleNoteSharing()) {
			lastComparison = TBaseHelper.compareTo(this.enableSingleNoteSharing,
					typedOther.enableSingleNoteSharing);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnableSponsoredAccounts()).compareTo(
				typedOther.isSetEnableSponsoredAccounts());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnableSponsoredAccounts()) {
			lastComparison = TBaseHelper.compareTo(this.enableSponsoredAccounts,
					typedOther.enableSponsoredAccounts);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnableTwitterSharing()).compareTo(
				typedOther.isSetEnableTwitterSharing());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnableTwitterSharing()) {
			lastComparison = TBaseHelper.compareTo(this.enableTwitterSharing,
					typedOther.enableTwitterSharing);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnableLinkedInSharing()).compareTo(
				typedOther.isSetEnableLinkedInSharing());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnableLinkedInSharing()) {
			lastComparison = TBaseHelper.compareTo(this.enableLinkedInSharing,
					typedOther.enableLinkedInSharing);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEnablePublicNotebooks()).compareTo(
				typedOther.isSetEnablePublicNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEnablePublicNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.enablePublicNotebooks,
					typedOther.enablePublicNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void read(TProtocol iprot) throws TException {
		...
		while (true) {
			...
			case 12: // ENABLE_LINKED_IN_SHARING
				...
				break;
			case 13: // ENABLE_PUBLIC_NOTEBOOKS
				if (field.type == TType.BOOL) {
	...
	public void validate() throws TException {
		...
		if (!isSetServiceHost()) {
			throw new TProtocolException("Required field 'serviceHost' is unset! Struct:"
					+ toString());
		}

		if (!isSetMarketingUrl()) {
			throw new TProtocolException("Required field 'marketingUrl' is unset! Struct:"
					+ toString());
		}

		if (!isSetSupportUrl()) {
			throw new TProtocolException("Required field 'supportUrl' is unset! Struct:"
					+ toString());
		}

		if (!isSetAccountEmailDomain()) {
			throw new TProtocolException("Required field 'accountEmailDomain' is unset! Struct:"
					+ toString());
		}
