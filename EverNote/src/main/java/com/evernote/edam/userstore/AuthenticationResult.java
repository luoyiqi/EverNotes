...
public class AuthenticationResult implements TBase<AuthenticationResult>, java.io.Serializable,
		Cloneable {
	...
	private static final TField CURRENT_TIME_FIELD_DESC = new TField("currentTime", TType.I64,
			(short) 1);
	private static final TField AUTHENTICATION_TOKEN_FIELD_DESC = new TField("authenticationToken",
			TType.STRING, (short) 2);
	private static final TField EXPIRATION_FIELD_DESC = new TField("expiration", TType.I64,
			(short) 3);
	private static final TField USER_FIELD_DESC = new TField("user", TType.STRUCT, (short) 4);
	private static final TField PUBLIC_USER_INFO_FIELD_DESC = new TField("publicUserInfo",
			TType.STRUCT, (short) 5);
	private static final TField NOTE_STORE_URL_FIELD_DESC = new TField("noteStoreUrl",
			TType.STRING, (short) 6);
	private static final TField WEB_API_URL_PREFIX_FIELD_DESC = new TField("webApiUrlPrefix",
			TType.STRING, (short) 7);
	private static final TField SECOND_FACTOR_REQUIRED_FIELD_DESC = new TField(
			"secondFactorRequired", TType.BOOL, (short) 8);
	private static final TField SECOND_FACTOR_DELIVERY_HINT_FIELD_DESC = new TField(
			"secondFactorDeliveryHint", TType.STRING, (short) 9);
	...
	public AuthenticationResult(long currentTime, String authenticationToken, long expiration) {
		this();
	...
	public boolean equals(AuthenticationResult that) {
		...
		boolean this_present_secondFactorDeliveryHint = true && this
				.isSetSecondFactorDeliveryHint();
		boolean that_present_secondFactorDeliveryHint = true && that
				.isSetSecondFactorDeliveryHint();
	...
	public int compareTo(AuthenticationResult other) {
		...
		AuthenticationResult typedOther = other;
		...
		lastComparison = Boolean.valueOf(isSetPublicUserInfo()).compareTo(
				typedOther.isSetPublicUserInfo());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPublicUserInfo()) {
			lastComparison = TBaseHelper.compareTo(this.publicUserInfo, typedOther.publicUserInfo);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoteStoreUrl()).compareTo(
				typedOther.isSetNoteStoreUrl());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoteStoreUrl()) {
			lastComparison = TBaseHelper.compareTo(this.noteStoreUrl, typedOther.noteStoreUrl);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetWebApiUrlPrefix()).compareTo(
				typedOther.isSetWebApiUrlPrefix());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetWebApiUrlPrefix()) {
			lastComparison = TBaseHelper
					.compareTo(this.webApiUrlPrefix, typedOther.webApiUrlPrefix);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetSecondFactorRequired()).compareTo(
				typedOther.isSetSecondFactorRequired());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetSecondFactorRequired()) {
			lastComparison = TBaseHelper.compareTo(this.secondFactorRequired,
					typedOther.secondFactorRequired);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetSecondFactorDeliveryHint()).compareTo(
				typedOther.isSetSecondFactorDeliveryHint());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetSecondFactorDeliveryHint()) {
			lastComparison = TBaseHelper.compareTo(this.secondFactorDeliveryHint,
					typedOther.secondFactorDeliveryHint);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws TException {
		...
		if (!isSetAuthenticationToken()) {
			throw new TProtocolException("Required field 'authenticationToken' is unset! Struct:"
					+ toString());
		}

		if (!isSetExpiration()) {
			throw new TProtocolException("Required field 'expiration' is unset! Struct:"
					+ toString());
		}
