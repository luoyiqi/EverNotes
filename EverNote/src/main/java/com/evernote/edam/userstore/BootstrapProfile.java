...
public class BootstrapProfile implements TBase<BootstrapProfile>, java.io.Serializable, Cloneable {
	...
	private static final TField SETTINGS_FIELD_DESC = new TField("settings", TType.STRUCT,
			(short) 2);
	...
	public BootstrapProfile(String name, BootstrapSettings settings) {
		this();
		this.name = name;
	...
	public int compareTo(BootstrapProfile other) {
		...
		BootstrapProfile typedOther = other;
		...
		if (isSetSettings()) {
			lastComparison = TBaseHelper.compareTo(this.settings, typedOther.settings);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
