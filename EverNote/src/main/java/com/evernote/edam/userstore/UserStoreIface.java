...
public interface UserStoreIface {
	 ...
	 *   constant for the client.
	 */
	public boolean checkVersion(String clientName, short edamVersionMajor, short edamVersionMinor)
			throws TException;
	 ...
	 * </ul>
	 */
	public AuthenticationResult authenticate(String username, String password, String consumerKey,
			String consumerSecret, boolean supportsTwoFactor)
	...
	public PublicUserInfo getPublicUserInfo(String username)
			...
			com.evernote.edam.error.EDAMSystemException, com.evernote.edam.error.EDAMUserException,
			TException;
