...
public class SharedNotebookRecipientSettings implements TBase<SharedNotebookRecipientSettings>,
	...
	private static final TField REMINDER_NOTIFY_EMAIL_FIELD_DESC = new TField(
			"reminderNotifyEmail", TType.BOOL, (short) 1);
	private static final TField REMINDER_NOTIFY_IN_APP_FIELD_DESC = new TField(
			"reminderNotifyInApp", TType.BOOL, (short) 2);
	...
	public int compareTo(SharedNotebookRecipientSettings other) {
		...
		SharedNotebookRecipientSettings typedOther = other;

		lastComparison = Boolean.valueOf(isSetReminderNotifyEmail()).compareTo(
				typedOther.isSetReminderNotifyEmail());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetReminderNotifyEmail()) {
			lastComparison = TBaseHelper.compareTo(this.reminderNotifyEmail,
					typedOther.reminderNotifyEmail);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetReminderNotifyInApp()).compareTo(
				typedOther.isSetReminderNotifyInApp());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetReminderNotifyInApp()) {
			lastComparison = TBaseHelper.compareTo(this.reminderNotifyInApp,
					typedOther.reminderNotifyInApp);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
