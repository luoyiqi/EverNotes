...
public class Resource implements TBase<Resource>, java.io.Serializable, Cloneable {
	...
	private static final TField RECOGNITION_FIELD_DESC = new TField("recognition", TType.STRUCT,
			(short) 9);
	...
	private static final TField UPDATE_SEQUENCE_NUM_FIELD_DESC = new TField("updateSequenceNum",
			TType.I32, (short) 12);
	private static final TField ALTERNATE_DATA_FIELD_DESC = new TField("alternateData",
	...
	public int compareTo(Resource other) {
		...
		if (isSetMime()) {
			lastComparison = TBaseHelper.compareTo(this.mime, typedOther.mime);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetRecognition()).compareTo(
				typedOther.isSetRecognition());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetRecognition()) {
			lastComparison = TBaseHelper.compareTo(this.recognition, typedOther.recognition);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetAlternateData()).compareTo(
				typedOther.isSetAlternateData());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetAlternateData()) {
			lastComparison = TBaseHelper.compareTo(this.alternateData, typedOther.alternateData);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
