...
public class SavedSearchScope implements TBase<SavedSearchScope>, java.io.Serializable, Cloneable {
	...
	private static final TField INCLUDE_ACCOUNT_FIELD_DESC = new TField("includeAccount",
			TType.BOOL, (short) 1);
	private static final TField INCLUDE_PERSONAL_LINKED_NOTEBOOKS_FIELD_DESC = new TField(
			"includePersonalLinkedNotebooks", TType.BOOL, (short) 2);
	private static final TField INCLUDE_BUSINESS_LINKED_NOTEBOOKS_FIELD_DESC = new TField(
			"includeBusinessLinkedNotebooks", TType.BOOL, (short) 3);
	...
	public boolean equals(SavedSearchScope that) {
		...
		boolean this_present_includePersonalLinkedNotebooks = true && this
				.isSetIncludePersonalLinkedNotebooks();
		boolean that_present_includePersonalLinkedNotebooks = true && that
				.isSetIncludePersonalLinkedNotebooks();
		if (this_present_includePersonalLinkedNotebooks
				|| that_present_includePersonalLinkedNotebooks) {
		...
		boolean this_present_includeBusinessLinkedNotebooks = true && this
				.isSetIncludeBusinessLinkedNotebooks();
		boolean that_present_includeBusinessLinkedNotebooks = true && that
				.isSetIncludeBusinessLinkedNotebooks();
		if (this_present_includeBusinessLinkedNotebooks
				|| that_present_includeBusinessLinkedNotebooks) {
	...
	public int compareTo(SavedSearchScope other) {
		...
		SavedSearchScope typedOther = other;

		lastComparison = Boolean.valueOf(isSetIncludeAccount()).compareTo(
				typedOther.isSetIncludeAccount());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetIncludeAccount()) {
			lastComparison = TBaseHelper.compareTo(this.includeAccount, typedOther.includeAccount);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetIncludePersonalLinkedNotebooks()).compareTo(
				typedOther.isSetIncludePersonalLinkedNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetIncludePersonalLinkedNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.includePersonalLinkedNotebooks,
					typedOther.includePersonalLinkedNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetIncludeBusinessLinkedNotebooks()).compareTo(
				typedOther.isSetIncludeBusinessLinkedNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetIncludeBusinessLinkedNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.includeBusinessLinkedNotebooks,
					typedOther.includeBusinessLinkedNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
