...
public class Publishing implements TBase<Publishing>, java.io.Serializable, Cloneable {
	...
	private static final TField ASCENDING_FIELD_DESC = new TField("ascending", TType.BOOL,
			(short) 3);
	private static final TField PUBLIC_DESCRIPTION_FIELD_DESC = new TField("publicDescription",
	...
	public int compareTo(Publishing other) {
		...
		lastComparison = Boolean.valueOf(isSetPublicDescription()).compareTo(
				typedOther.isSetPublicDescription());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPublicDescription()) {
			lastComparison = TBaseHelper.compareTo(this.publicDescription,
					typedOther.publicDescription);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
