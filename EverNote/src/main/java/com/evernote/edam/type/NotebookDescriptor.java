...
public class NotebookDescriptor implements TBase<NotebookDescriptor>, java.io.Serializable,
		Cloneable {
	...
	private static final TField NOTEBOOK_DISPLAY_NAME_FIELD_DESC = new TField(
			"notebookDisplayName", TType.STRING, (short) 2);
	private static final TField CONTACT_NAME_FIELD_DESC = new TField("contactName", TType.STRING,
			(short) 3);
	private static final TField HAS_SHARED_NOTEBOOK_FIELD_DESC = new TField("hasSharedNotebook",
			TType.BOOL, (short) 4);
	private static final TField JOINED_USER_COUNT_FIELD_DESC = new TField("joinedUserCount",
			TType.I32, (short) 5);
	...
	public int compareTo(NotebookDescriptor other) {
		...
		NotebookDescriptor typedOther = other;
		...
		lastComparison = Boolean.valueOf(isSetNotebookDisplayName()).compareTo(
				typedOther.isSetNotebookDisplayName());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNotebookDisplayName()) {
			lastComparison = TBaseHelper.compareTo(this.notebookDisplayName,
					typedOther.notebookDisplayName);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetContactName()).compareTo(
				typedOther.isSetContactName());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetContactName()) {
		...
		lastComparison = Boolean.valueOf(isSetHasSharedNotebook()).compareTo(
				typedOther.isSetHasSharedNotebook());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetHasSharedNotebook()) {
			lastComparison = TBaseHelper.compareTo(this.hasSharedNotebook,
					typedOther.hasSharedNotebook);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetJoinedUserCount()).compareTo(
				typedOther.isSetJoinedUserCount());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetJoinedUserCount()) {
			lastComparison = TBaseHelper
					.compareTo(this.joinedUserCount, typedOther.joinedUserCount);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
