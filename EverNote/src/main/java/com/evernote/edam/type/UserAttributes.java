...
public class UserAttributes implements TBase<UserAttributes>, java.io.Serializable, Cloneable {
	...
	private static final TField DEFAULT_LOCATION_NAME_FIELD_DESC = new TField(
			"defaultLocationName", TType.STRING, (short) 1);
	private static final TField DEFAULT_LATITUDE_FIELD_DESC = new TField("defaultLatitude",
			TType.DOUBLE, (short) 2);
	private static final TField DEFAULT_LONGITUDE_FIELD_DESC = new TField("defaultLongitude",
			TType.DOUBLE, (short) 3);
	private static final TField PREACTIVATION_FIELD_DESC = new TField("preactivation", TType.BOOL,
			(short) 4);
	private static final TField VIEWED_PROMOTIONS_FIELD_DESC = new TField("viewedPromotions",
			TType.LIST, (short) 5);
	private static final TField INCOMING_EMAIL_ADDRESS_FIELD_DESC = new TField(
			"incomingEmailAddress", TType.STRING, (short) 6);
	private static final TField RECENT_MAILED_ADDRESSES_FIELD_DESC = new TField(
			"recentMailedAddresses", TType.LIST, (short) 7);
	private static final TField COMMENTS_FIELD_DESC = new TField("comments", TType.STRING,
			(short) 9);
	private static final TField DATE_AGREED_TO_TERMS_OF_SERVICE_FIELD_DESC = new TField(
			"dateAgreedToTermsOfService", TType.I64, (short) 11);
	private static final TField MAX_REFERRALS_FIELD_DESC = new TField("maxReferrals", TType.I32,
			(short) 12);
	private static final TField REFERRAL_COUNT_FIELD_DESC = new TField("referralCount", TType.I32,
			(short) 13);
	private static final TField REFERER_CODE_FIELD_DESC = new TField("refererCode", TType.STRING,
			(short) 14);
	private static final TField SENT_EMAIL_DATE_FIELD_DESC = new TField("sentEmailDate", TType.I64,
			(short) 15);
	private static final TField SENT_EMAIL_COUNT_FIELD_DESC = new TField("sentEmailCount",
			TType.I32, (short) 16);
	private static final TField DAILY_EMAIL_LIMIT_FIELD_DESC = new TField("dailyEmailLimit",
			TType.I32, (short) 17);
	private static final TField EMAIL_OPT_OUT_DATE_FIELD_DESC = new TField("emailOptOutDate",
			TType.I64, (short) 18);
	private static final TField PARTNER_EMAIL_OPT_IN_DATE_FIELD_DESC = new TField(
			"partnerEmailOptInDate", TType.I64, (short) 19);
	private static final TField PREFERRED_LANGUAGE_FIELD_DESC = new TField("preferredLanguage",
			TType.STRING, (short) 20);
	private static final TField PREFERRED_COUNTRY_FIELD_DESC = new TField("preferredCountry",
			TType.STRING, (short) 21);
	private static final TField CLIP_FULL_PAGE_FIELD_DESC = new TField("clipFullPage", TType.BOOL,
			(short) 22);
	private static final TField TWITTER_USER_NAME_FIELD_DESC = new TField("twitterUserName",
			TType.STRING, (short) 23);
	private static final TField TWITTER_ID_FIELD_DESC = new TField("twitterId", TType.STRING,
			(short) 24);
	private static final TField GROUP_NAME_FIELD_DESC = new TField("groupName", TType.STRING,
			(short) 25);
	private static final TField RECOGNITION_LANGUAGE_FIELD_DESC = new TField("recognitionLanguage",
			TType.STRING, (short) 26);
	private static final TField REFERRAL_PROOF_FIELD_DESC = new TField("referralProof",
			TType.STRING, (short) 28);
	private static final TField EDUCATIONAL_DISCOUNT_FIELD_DESC = new TField("educationalDiscount",
			TType.BOOL, (short) 29);
	private static final TField BUSINESS_ADDRESS_FIELD_DESC = new TField("businessAddress",
			TType.STRING, (short) 30);
	private static final TField HIDE_SPONSOR_BILLING_FIELD_DESC = new TField("hideSponsorBilling",
			TType.BOOL, (short) 31);
	private static final TField TAX_EXEMPT_FIELD_DESC = new TField("taxExempt", TType.BOOL,
			(short) 32);
	private static final TField USE_EMAIL_AUTO_FILING_FIELD_DESC = new TField("useEmailAutoFiling",
			TType.BOOL, (short) 33);
	private static final TField REMINDER_EMAIL_CONFIG_FIELD_DESC = new TField(
			"reminderEmailConfig", TType.I32, (short) 34);
	...
	private final boolean[] __isset_vector = new boolean[16];
	...
	public boolean equals(UserAttributes that) {
		...
		boolean this_present_dateAgreedToTermsOfService = true && this
				.isSetDateAgreedToTermsOfService();
		boolean that_present_dateAgreedToTermsOfService = true && that
				.isSetDateAgreedToTermsOfService();
	...
	public int compareTo(UserAttributes other) {
		...
		UserAttributes typedOther = other;

		lastComparison = Boolean.valueOf(isSetDefaultLocationName()).compareTo(
				typedOther.isSetDefaultLocationName());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetDefaultLocationName()) {
			lastComparison = TBaseHelper.compareTo(this.defaultLocationName,
					typedOther.defaultLocationName);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetDefaultLatitude()).compareTo(
				typedOther.isSetDefaultLatitude());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetDefaultLatitude()) {
			lastComparison = TBaseHelper
					.compareTo(this.defaultLatitude, typedOther.defaultLatitude);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetDefaultLongitude()).compareTo(
				typedOther.isSetDefaultLongitude());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetDefaultLongitude()) {
			lastComparison = TBaseHelper.compareTo(this.defaultLongitude,
					typedOther.defaultLongitude);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPreactivation()).compareTo(
				typedOther.isSetPreactivation());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPreactivation()) {
			lastComparison = TBaseHelper.compareTo(this.preactivation, typedOther.preactivation);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetViewedPromotions()).compareTo(
				typedOther.isSetViewedPromotions());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetViewedPromotions()) {
			lastComparison = TBaseHelper.compareTo(this.viewedPromotions,
					typedOther.viewedPromotions);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetIncomingEmailAddress()).compareTo(
				typedOther.isSetIncomingEmailAddress());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetIncomingEmailAddress()) {
			lastComparison = TBaseHelper.compareTo(this.incomingEmailAddress,
					typedOther.incomingEmailAddress);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetRecentMailedAddresses()).compareTo(
				typedOther.isSetRecentMailedAddresses());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetRecentMailedAddresses()) {
			lastComparison = TBaseHelper.compareTo(this.recentMailedAddresses,
					typedOther.recentMailedAddresses);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetDateAgreedToTermsOfService()).compareTo(
				typedOther.isSetDateAgreedToTermsOfService());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetDateAgreedToTermsOfService()) {
			lastComparison = TBaseHelper.compareTo(this.dateAgreedToTermsOfService,
					typedOther.dateAgreedToTermsOfService);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetMaxReferrals()).compareTo(
				typedOther.isSetMaxReferrals());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetMaxReferrals()) {
			lastComparison = TBaseHelper.compareTo(this.maxReferrals, typedOther.maxReferrals);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetReferralCount()).compareTo(
				typedOther.isSetReferralCount());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetReferralCount()) {
			lastComparison = TBaseHelper.compareTo(this.referralCount, typedOther.referralCount);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetRefererCode()).compareTo(
				typedOther.isSetRefererCode());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetRefererCode()) {
			lastComparison = TBaseHelper.compareTo(this.refererCode, typedOther.refererCode);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetSentEmailDate()).compareTo(
				typedOther.isSetSentEmailDate());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetSentEmailDate()) {
			lastComparison = TBaseHelper.compareTo(this.sentEmailDate, typedOther.sentEmailDate);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetSentEmailCount()).compareTo(
				typedOther.isSetSentEmailCount());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetSentEmailCount()) {
			lastComparison = TBaseHelper.compareTo(this.sentEmailCount, typedOther.sentEmailCount);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetDailyEmailLimit()).compareTo(
				typedOther.isSetDailyEmailLimit());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetDailyEmailLimit()) {
			lastComparison = TBaseHelper
					.compareTo(this.dailyEmailLimit, typedOther.dailyEmailLimit);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEmailOptOutDate()).compareTo(
				typedOther.isSetEmailOptOutDate());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEmailOptOutDate()) {
			lastComparison = TBaseHelper
					.compareTo(this.emailOptOutDate, typedOther.emailOptOutDate);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPartnerEmailOptInDate()).compareTo(
				typedOther.isSetPartnerEmailOptInDate());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPartnerEmailOptInDate()) {
			lastComparison = TBaseHelper.compareTo(this.partnerEmailOptInDate,
					typedOther.partnerEmailOptInDate);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPreferredLanguage()).compareTo(
				typedOther.isSetPreferredLanguage());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPreferredLanguage()) {
			lastComparison = TBaseHelper.compareTo(this.preferredLanguage,
					typedOther.preferredLanguage);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPreferredCountry()).compareTo(
				typedOther.isSetPreferredCountry());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPreferredCountry()) {
			lastComparison = TBaseHelper.compareTo(this.preferredCountry,
					typedOther.preferredCountry);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetClipFullPage()).compareTo(
				typedOther.isSetClipFullPage());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetClipFullPage()) {
			lastComparison = TBaseHelper.compareTo(this.clipFullPage, typedOther.clipFullPage);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetTwitterUserName()).compareTo(
				typedOther.isSetTwitterUserName());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetTwitterUserName()) {
			lastComparison = TBaseHelper
					.compareTo(this.twitterUserName, typedOther.twitterUserName);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetTwitterId()) {
			lastComparison = TBaseHelper.compareTo(this.twitterId, typedOther.twitterId);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetRecognitionLanguage()).compareTo(
				typedOther.isSetRecognitionLanguage());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetRecognitionLanguage()) {
			lastComparison = TBaseHelper.compareTo(this.recognitionLanguage,
					typedOther.recognitionLanguage);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetReferralProof()).compareTo(
				typedOther.isSetReferralProof());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetReferralProof()) {
			lastComparison = TBaseHelper.compareTo(this.referralProof, typedOther.referralProof);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetEducationalDiscount()).compareTo(
				typedOther.isSetEducationalDiscount());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetEducationalDiscount()) {
			lastComparison = TBaseHelper.compareTo(this.educationalDiscount,
					typedOther.educationalDiscount);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetBusinessAddress()).compareTo(
				typedOther.isSetBusinessAddress());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetBusinessAddress()) {
			lastComparison = TBaseHelper
					.compareTo(this.businessAddress, typedOther.businessAddress);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetHideSponsorBilling()).compareTo(
				typedOther.isSetHideSponsorBilling());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetHideSponsorBilling()) {
			lastComparison = TBaseHelper.compareTo(this.hideSponsorBilling,
					typedOther.hideSponsorBilling);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetTaxExempt()) {
			lastComparison = TBaseHelper.compareTo(this.taxExempt, typedOther.taxExempt);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetUseEmailAutoFiling()).compareTo(
				typedOther.isSetUseEmailAutoFiling());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetUseEmailAutoFiling()) {
			lastComparison = TBaseHelper.compareTo(this.useEmailAutoFiling,
					typedOther.useEmailAutoFiling);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetReminderEmailConfig()).compareTo(
				typedOther.isSetReminderEmailConfig());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetReminderEmailConfig()) {
			lastComparison = TBaseHelper.compareTo(this.reminderEmailConfig,
					typedOther.reminderEmailConfig);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
