...
public class Note implements TBase<Note>, java.io.Serializable, Cloneable {
	...
	private static final TField CONTENT_HASH_FIELD_DESC = new TField("contentHash", TType.STRING,
			(short) 4);
	...
	private static final TField ATTRIBUTES_FIELD_DESC = new TField("attributes", TType.STRUCT,
			(short) 14);
	private static final TField TAG_NAMES_FIELD_DESC = new TField("tagNames", TType.LIST,
			(short) 15);
	...
	public int compareTo(Note other) {
		...
		if (isSetTagNames()) {
			lastComparison = TBaseHelper.compareTo(this.tagNames, typedOther.tagNames);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
