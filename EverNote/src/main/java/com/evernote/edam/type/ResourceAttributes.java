...
public class ResourceAttributes implements TBase<ResourceAttributes>, java.io.Serializable,
		Cloneable {
	...
	private static final TField ALTITUDE_FIELD_DESC = new TField("altitude", TType.DOUBLE,
			(short) 5);
	private static final TField CAMERA_MAKE_FIELD_DESC = new TField("cameraMake", TType.STRING,
			(short) 6);
	private static final TField CAMERA_MODEL_FIELD_DESC = new TField("cameraModel", TType.STRING,
			(short) 7);
	private static final TField CLIENT_WILL_INDEX_FIELD_DESC = new TField("clientWillIndex",
			TType.BOOL, (short) 8);
	private static final TField RECO_TYPE_FIELD_DESC = new TField("recoType", TType.STRING,
			(short) 9);
	private static final TField FILE_NAME_FIELD_DESC = new TField("fileName", TType.STRING,
			(short) 10);
	private static final TField ATTACHMENT_FIELD_DESC = new TField("attachment", TType.BOOL,
			(short) 11);
	private static final TField APPLICATION_DATA_FIELD_DESC = new TField("applicationData",
			TType.STRUCT, (short) 12);
	...
	public int compareTo(ResourceAttributes other) {
		...
		ResourceAttributes typedOther = other;
		...
		if (isSetCameraMake()) {
			lastComparison = TBaseHelper.compareTo(this.cameraMake, typedOther.cameraMake);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetCameraModel()).compareTo(
				typedOther.isSetCameraModel());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetCameraModel()) {
			lastComparison = TBaseHelper.compareTo(this.cameraModel, typedOther.cameraModel);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetClientWillIndex()).compareTo(
				typedOther.isSetClientWillIndex());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetClientWillIndex()) {
			lastComparison = TBaseHelper
					.compareTo(this.clientWillIndex, typedOther.clientWillIndex);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetRecoType()) {
			lastComparison = TBaseHelper.compareTo(this.recoType, typedOther.recoType);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetAttachment()) {
			lastComparison = TBaseHelper.compareTo(this.attachment, typedOther.attachment);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
