...
public class BusinessNotebook implements TBase<BusinessNotebook>, java.io.Serializable, Cloneable {
	...
	private static final TField NOTEBOOK_DESCRIPTION_FIELD_DESC = new TField("notebookDescription",
			TType.STRING, (short) 1);
	private static final TField PRIVILEGE_FIELD_DESC = new TField("privilege", TType.I32, (short) 2);
	private static final TField RECOMMENDED_FIELD_DESC = new TField("recommended", TType.BOOL,
			(short) 3);
	...
	public int compareTo(BusinessNotebook other) {
		...
		BusinessNotebook typedOther = other;

		lastComparison = Boolean.valueOf(isSetNotebookDescription()).compareTo(
				typedOther.isSetNotebookDescription());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNotebookDescription()) {
			lastComparison = TBaseHelper.compareTo(this.notebookDescription,
					typedOther.notebookDescription);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetRecommended()).compareTo(
				typedOther.isSetRecommended());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetRecommended()) {
			lastComparison = TBaseHelper.compareTo(this.recommended, typedOther.recommended);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
