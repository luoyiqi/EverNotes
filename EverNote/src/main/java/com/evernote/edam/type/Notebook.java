...
public class Notebook implements TBase<Notebook>, java.io.Serializable, Cloneable {
	...
	private static final TField UPDATE_SEQUENCE_NUM_FIELD_DESC = new TField("updateSequenceNum",
			TType.I32, (short) 5);
	private static final TField DEFAULT_NOTEBOOK_FIELD_DESC = new TField("defaultNotebook",
			TType.BOOL, (short) 6);
	private static final TField SERVICE_CREATED_FIELD_DESC = new TField("serviceCreated",
			TType.I64, (short) 7);
	private static final TField SERVICE_UPDATED_FIELD_DESC = new TField("serviceUpdated",
			TType.I64, (short) 8);
	private static final TField PUBLISHING_FIELD_DESC = new TField("publishing", TType.STRUCT,
			(short) 10);
	private static final TField PUBLISHED_FIELD_DESC = new TField("published", TType.BOOL,
			(short) 11);
	private static final TField STACK_FIELD_DESC = new TField("stack", TType.STRING, (short) 12);
	private static final TField SHARED_NOTEBOOK_IDS_FIELD_DESC = new TField("sharedNotebookIds",
			TType.LIST, (short) 13);
	private static final TField SHARED_NOTEBOOKS_FIELD_DESC = new TField("sharedNotebooks",
			TType.LIST, (short) 14);
	private static final TField BUSINESS_NOTEBOOK_FIELD_DESC = new TField("businessNotebook",
			TType.STRUCT, (short) 15);
	private static final TField CONTACT_FIELD_DESC = new TField("contact", TType.STRUCT, (short) 16);
	private static final TField RESTRICTIONS_FIELD_DESC = new TField("restrictions", TType.STRUCT,
			(short) 17);
	...
	private final boolean[] __isset_vector = new boolean[5];
	...
	public int compareTo(Notebook other) {
		...
		lastComparison = Boolean.valueOf(isSetDefaultNotebook()).compareTo(
				typedOther.isSetDefaultNotebook());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetDefaultNotebook()) {
			lastComparison = TBaseHelper
					.compareTo(this.defaultNotebook, typedOther.defaultNotebook);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetServiceCreated()).compareTo(
				typedOther.isSetServiceCreated());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetServiceCreated()) {
			lastComparison = TBaseHelper.compareTo(this.serviceCreated, typedOther.serviceCreated);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetServiceUpdated()).compareTo(
				typedOther.isSetServiceUpdated());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetServiceUpdated()) {
			lastComparison = TBaseHelper.compareTo(this.serviceUpdated, typedOther.serviceUpdated);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetPublishing()) {
			lastComparison = TBaseHelper.compareTo(this.publishing, typedOther.publishing);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetPublished()) {
			lastComparison = TBaseHelper.compareTo(this.published, typedOther.published);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetSharedNotebooks()).compareTo(
				typedOther.isSetSharedNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetSharedNotebooks()) {
			lastComparison = TBaseHelper
					.compareTo(this.sharedNotebooks, typedOther.sharedNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetBusinessNotebook()).compareTo(
				typedOther.isSetBusinessNotebook());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetBusinessNotebook()) {
			lastComparison = TBaseHelper.compareTo(this.businessNotebook,
					typedOther.businessNotebook);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetContact()) {
			lastComparison = TBaseHelper.compareTo(this.contact, typedOther.contact);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetRestrictions()).compareTo(
				typedOther.isSetRestrictions());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetRestrictions()) {
			lastComparison = TBaseHelper.compareTo(this.restrictions, typedOther.restrictions);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
