...
public class Tag implements TBase<Tag>, java.io.Serializable, Cloneable {
	...
	private static final TField PARENT_GUID_FIELD_DESC = new TField("parentGuid", TType.STRING,
			(short) 3);
	...
	public int compareTo(Tag other) {
		...
		if (isSetParentGuid()) {
			lastComparison = TBaseHelper.compareTo(this.parentGuid, typedOther.parentGuid);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
