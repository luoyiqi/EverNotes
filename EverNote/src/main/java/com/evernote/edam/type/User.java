...
public class User implements TBase<User>, java.io.Serializable, Cloneable {
	...
	private static final TField TIMEZONE_FIELD_DESC = new TField("timezone", TType.STRING,
			(short) 6);
	...
	private static final TField SHARD_ID_FIELD_DESC = new TField("shardId", TType.STRING,
			(short) 14);
	private static final TField ATTRIBUTES_FIELD_DESC = new TField("attributes", TType.STRUCT,
			(short) 15);
	private static final TField ACCOUNTING_FIELD_DESC = new TField("accounting", TType.STRUCT,
			(short) 16);
	private static final TField PREMIUM_INFO_FIELD_DESC = new TField("premiumInfo", TType.STRUCT,
			(short) 17);
	private static final TField BUSINESS_USER_INFO_FIELD_DESC = new TField("businessUserInfo",
			TType.STRUCT, (short) 18);
	...
	public int compareTo(User other) {
		...
		if (isSetTimezone()) {
			lastComparison = TBaseHelper.compareTo(this.timezone, typedOther.timezone);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetAccounting()) {
			lastComparison = TBaseHelper.compareTo(this.accounting, typedOther.accounting);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumInfo()).compareTo(
				typedOther.isSetPremiumInfo());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumInfo()) {
			lastComparison = TBaseHelper.compareTo(this.premiumInfo, typedOther.premiumInfo);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetBusinessUserInfo()).compareTo(
				typedOther.isSetBusinessUserInfo());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetBusinessUserInfo()) {
			lastComparison = TBaseHelper.compareTo(this.businessUserInfo,
					typedOther.businessUserInfo);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
