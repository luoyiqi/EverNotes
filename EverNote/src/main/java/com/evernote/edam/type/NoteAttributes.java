...
public class NoteAttributes implements TBase<NoteAttributes>, java.io.Serializable, Cloneable {
	...
	private static final TField SUBJECT_DATE_FIELD_DESC = new TField("subjectDate", TType.I64,
			(short) 1);
	private static final TField LATITUDE_FIELD_DESC = new TField("latitude", TType.DOUBLE,
			(short) 10);
	private static final TField LONGITUDE_FIELD_DESC = new TField("longitude", TType.DOUBLE,
			(short) 11);
	private static final TField ALTITUDE_FIELD_DESC = new TField("altitude", TType.DOUBLE,
			(short) 12);
	...
	private static final TField SOURCE_URL_FIELD_DESC = new TField("sourceURL", TType.STRING,
			(short) 15);
	private static final TField SOURCE_APPLICATION_FIELD_DESC = new TField("sourceApplication",
			TType.STRING, (short) 16);
	private static final TField SHARE_DATE_FIELD_DESC = new TField("shareDate", TType.I64,
			(short) 17);
	private static final TField REMINDER_ORDER_FIELD_DESC = new TField("reminderOrder", TType.I64,
			(short) 18);
	private static final TField REMINDER_DONE_TIME_FIELD_DESC = new TField("reminderDoneTime",
			TType.I64, (short) 19);
	private static final TField REMINDER_TIME_FIELD_DESC = new TField("reminderTime", TType.I64,
			(short) 20);
	private static final TField PLACE_NAME_FIELD_DESC = new TField("placeName", TType.STRING,
			(short) 21);
	private static final TField CONTENT_CLASS_FIELD_DESC = new TField("contentClass", TType.STRING,
			(short) 22);
	private static final TField APPLICATION_DATA_FIELD_DESC = new TField("applicationData",
			TType.STRUCT, (short) 23);
	private static final TField LAST_EDITED_BY_FIELD_DESC = new TField("lastEditedBy",
			TType.STRING, (short) 24);
	private static final TField CLASSIFICATIONS_FIELD_DESC = new TField("classifications",
			TType.MAP, (short) 26);
	private static final TField CREATOR_ID_FIELD_DESC = new TField("creatorId", TType.I32,
			(short) 27);
	private static final TField LAST_EDITOR_ID_FIELD_DESC = new TField("lastEditorId", TType.I32,
			(short) 28);
	...
	private final boolean[] __isset_vector = new boolean[10];
	...
	public NoteAttributes(NoteAttributes other) {
		...
		if (other.isSetClassifications()) {
			...
			for (Map.Entry<String, String> other_element : other.classifications.entrySet()) {
				...
				__this__classifications.put(__this__classifications_copy_key,
						__this__classifications_copy_value);
			}
	...
	public int compareTo(NoteAttributes other) {
		...
		NoteAttributes typedOther = other;

		lastComparison = Boolean.valueOf(isSetSubjectDate()).compareTo(
				typedOther.isSetSubjectDate());
		if (lastComparison != 0) {
		...
		lastComparison = Boolean.valueOf(isSetSourceApplication()).compareTo(
				typedOther.isSetSourceApplication());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetSourceApplication()) {
			lastComparison = TBaseHelper.compareTo(this.sourceApplication,
					typedOther.sourceApplication);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetReminderOrder()).compareTo(
				typedOther.isSetReminderOrder());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetReminderOrder()) {
			lastComparison = TBaseHelper.compareTo(this.reminderOrder, typedOther.reminderOrder);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetReminderDoneTime()).compareTo(
				typedOther.isSetReminderDoneTime());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetReminderDoneTime()) {
			lastComparison = TBaseHelper.compareTo(this.reminderDoneTime,
					typedOther.reminderDoneTime);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetReminderTime()).compareTo(
				typedOther.isSetReminderTime());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetReminderTime()) {
			lastComparison = TBaseHelper.compareTo(this.reminderTime, typedOther.reminderTime);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetContentClass()).compareTo(
				typedOther.isSetContentClass());
		if (lastComparison != 0) {
			return lastComparison;
		}
		...
		lastComparison = Boolean.valueOf(isSetApplicationData()).compareTo(
				typedOther.isSetApplicationData());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetApplicationData()) {
			lastComparison = TBaseHelper
					.compareTo(this.applicationData, typedOther.applicationData);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetLastEditedBy()).compareTo(
				typedOther.isSetLastEditedBy());
		if (lastComparison != 0) {
			return lastComparison;
		}
		...
		lastComparison = Boolean.valueOf(isSetClassifications()).compareTo(
				typedOther.isSetClassifications());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetClassifications()) {
			lastComparison = TBaseHelper
					.compareTo(this.classifications, typedOther.classifications);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetLastEditorId()).compareTo(
				typedOther.isSetLastEditorId());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLastEditorId()) {
			lastComparison = TBaseHelper.compareTo(this.lastEditorId, typedOther.lastEditorId);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void write(TProtocol oprot) throws TException {
		...
		if (this.classifications != null) {
			if (isSetClassifications()) {
				...
				{
					oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.classifications
							.size()));
