...
public class PremiumInfo implements TBase<PremiumInfo>, java.io.Serializable, Cloneable {
	...
	private static final TField CURRENT_TIME_FIELD_DESC = new TField("currentTime", TType.I64,
			(short) 1);
	private static final TField PREMIUM_FIELD_DESC = new TField("premium", TType.BOOL, (short) 2);
	private static final TField PREMIUM_RECURRING_FIELD_DESC = new TField("premiumRecurring",
			TType.BOOL, (short) 3);
	private static final TField PREMIUM_EXPIRATION_DATE_FIELD_DESC = new TField(
			"premiumExpirationDate", TType.I64, (short) 4);
	private static final TField PREMIUM_EXTENDABLE_FIELD_DESC = new TField("premiumExtendable",
			TType.BOOL, (short) 5);
	private static final TField PREMIUM_PENDING_FIELD_DESC = new TField("premiumPending",
			TType.BOOL, (short) 6);
	private static final TField PREMIUM_CANCELLATION_PENDING_FIELD_DESC = new TField(
			"premiumCancellationPending", TType.BOOL, (short) 7);
	private static final TField CAN_PURCHASE_UPLOAD_ALLOWANCE_FIELD_DESC = new TField(
			"canPurchaseUploadAllowance", TType.BOOL, (short) 8);
	private static final TField SPONSORED_GROUP_NAME_FIELD_DESC = new TField("sponsoredGroupName",
			TType.STRING, (short) 9);
	private static final TField SPONSORED_GROUP_ROLE_FIELD_DESC = new TField("sponsoredGroupRole",
			TType.I32, (short) 10);
	private static final TField PREMIUM_UPGRADABLE_FIELD_DESC = new TField("premiumUpgradable",
			TType.BOOL, (short) 11);
	...
	public PremiumInfo(long currentTime, boolean premium, boolean premiumRecurring,
			boolean premiumExtendable, boolean premiumPending, boolean premiumCancellationPending,
	...
	public int compareTo(PremiumInfo other) {
		...
		PremiumInfo typedOther = other;

		lastComparison = Boolean.valueOf(isSetCurrentTime()).compareTo(
				typedOther.isSetCurrentTime());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetCurrentTime()) {
			lastComparison = TBaseHelper.compareTo(this.currentTime, typedOther.currentTime);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetPremiumRecurring()).compareTo(
				typedOther.isSetPremiumRecurring());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumRecurring()) {
			lastComparison = TBaseHelper.compareTo(this.premiumRecurring,
					typedOther.premiumRecurring);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumExpirationDate()).compareTo(
				typedOther.isSetPremiumExpirationDate());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumExpirationDate()) {
			lastComparison = TBaseHelper.compareTo(this.premiumExpirationDate,
					typedOther.premiumExpirationDate);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumExtendable()).compareTo(
				typedOther.isSetPremiumExtendable());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumExtendable()) {
			lastComparison = TBaseHelper.compareTo(this.premiumExtendable,
					typedOther.premiumExtendable);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumPending()).compareTo(
				typedOther.isSetPremiumPending());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumPending()) {
			lastComparison = TBaseHelper.compareTo(this.premiumPending, typedOther.premiumPending);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumCancellationPending()).compareTo(
				typedOther.isSetPremiumCancellationPending());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumCancellationPending()) {
			lastComparison = TBaseHelper.compareTo(this.premiumCancellationPending,
					typedOther.premiumCancellationPending);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetCanPurchaseUploadAllowance()).compareTo(
				typedOther.isSetCanPurchaseUploadAllowance());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetCanPurchaseUploadAllowance()) {
			lastComparison = TBaseHelper.compareTo(this.canPurchaseUploadAllowance,
					typedOther.canPurchaseUploadAllowance);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetSponsoredGroupName()).compareTo(
				typedOther.isSetSponsoredGroupName());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetSponsoredGroupName()) {
			lastComparison = TBaseHelper.compareTo(this.sponsoredGroupName,
					typedOther.sponsoredGroupName);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetSponsoredGroupRole()).compareTo(
				typedOther.isSetSponsoredGroupRole());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetSponsoredGroupRole()) {
			lastComparison = TBaseHelper.compareTo(this.sponsoredGroupRole,
					typedOther.sponsoredGroupRole);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumUpgradable()).compareTo(
				typedOther.isSetPremiumUpgradable());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumUpgradable()) {
			lastComparison = TBaseHelper.compareTo(this.premiumUpgradable,
					typedOther.premiumUpgradable);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws TException {
		...
		if (!isSetCurrentTime()) {
			throw new TProtocolException("Required field 'currentTime' is unset! Struct:"
					+ toString());
		}
		...
		if (!isSetPremiumRecurring()) {
			throw new TProtocolException("Required field 'premiumRecurring' is unset! Struct:"
					+ toString());
		}

		if (!isSetPremiumExtendable()) {
			throw new TProtocolException("Required field 'premiumExtendable' is unset! Struct:"
					+ toString());
		}

		if (!isSetPremiumPending()) {
			throw new TProtocolException("Required field 'premiumPending' is unset! Struct:"
					+ toString());
		}

		if (!isSetPremiumCancellationPending()) {
			throw new TProtocolException(
					"Required field 'premiumCancellationPending' is unset! Struct:" + toString());
		}

		if (!isSetCanPurchaseUploadAllowance()) {
			throw new TProtocolException(
					"Required field 'canPurchaseUploadAllowance' is unset! Struct:" + toString());
		}
