...
public class NotebookRestrictions implements TBase<NotebookRestrictions>, java.io.Serializable,
		Cloneable {
	private static final TStruct STRUCT_DESC = new TStruct("NotebookRestrictions");

	private static final TField NO_READ_NOTES_FIELD_DESC = new TField("noReadNotes", TType.BOOL,
			(short) 1);
	private static final TField NO_CREATE_NOTES_FIELD_DESC = new TField("noCreateNotes",
			TType.BOOL, (short) 2);
	private static final TField NO_UPDATE_NOTES_FIELD_DESC = new TField("noUpdateNotes",
			TType.BOOL, (short) 3);
	private static final TField NO_EXPUNGE_NOTES_FIELD_DESC = new TField("noExpungeNotes",
			TType.BOOL, (short) 4);
	private static final TField NO_SHARE_NOTES_FIELD_DESC = new TField("noShareNotes", TType.BOOL,
			(short) 5);
	private static final TField NO_EMAIL_NOTES_FIELD_DESC = new TField("noEmailNotes", TType.BOOL,
			(short) 6);
	private static final TField NO_SEND_MESSAGE_TO_RECIPIENTS_FIELD_DESC = new TField(
			"noSendMessageToRecipients", TType.BOOL, (short) 7);
	private static final TField NO_UPDATE_NOTEBOOK_FIELD_DESC = new TField("noUpdateNotebook",
			TType.BOOL, (short) 8);
	private static final TField NO_EXPUNGE_NOTEBOOK_FIELD_DESC = new TField("noExpungeNotebook",
			TType.BOOL, (short) 9);
	private static final TField NO_SET_DEFAULT_NOTEBOOK_FIELD_DESC = new TField(
			"noSetDefaultNotebook", TType.BOOL, (short) 10);
	private static final TField NO_SET_NOTEBOOK_STACK_FIELD_DESC = new TField("noSetNotebookStack",
			TType.BOOL, (short) 11);
	private static final TField NO_PUBLISH_TO_PUBLIC_FIELD_DESC = new TField("noPublishToPublic",
			TType.BOOL, (short) 12);
	private static final TField NO_PUBLISH_TO_BUSINESS_LIBRARY_FIELD_DESC = new TField(
			"noPublishToBusinessLibrary", TType.BOOL, (short) 13);
	private static final TField NO_CREATE_TAGS_FIELD_DESC = new TField("noCreateTags", TType.BOOL,
			(short) 14);
	private static final TField NO_UPDATE_TAGS_FIELD_DESC = new TField("noUpdateTags", TType.BOOL,
			(short) 15);
	private static final TField NO_EXPUNGE_TAGS_FIELD_DESC = new TField("noExpungeTags",
			TType.BOOL, (short) 16);
	private static final TField NO_SET_PARENT_TAG_FIELD_DESC = new TField("noSetParentTag",
			TType.BOOL, (short) 17);
	private static final TField NO_CREATE_SHARED_NOTEBOOKS_FIELD_DESC = new TField(
			"noCreateSharedNotebooks", TType.BOOL, (short) 18);
	private static final TField UPDATE_WHICH_SHARED_NOTEBOOK_RESTRICTIONS_FIELD_DESC = new TField(
			"updateWhichSharedNotebookRestrictions", TType.I32, (short) 19);
	private static final TField EXPUNGE_WHICH_SHARED_NOTEBOOK_RESTRICTIONS_FIELD_DESC = new TField(
			"expungeWhichSharedNotebookRestrictions", TType.I32, (short) 20);
	...
	private final boolean[] __isset_vector = new boolean[18];
	 ...
	 * @see SharedNotebookInstanceRestrictions
	 */
	public void setUpdateWhichSharedNotebookRestrictions(
	 ...
	 * @see SharedNotebookInstanceRestrictions
	 */
	public void setExpungeWhichSharedNotebookRestrictions(
	...
	public boolean equals(NotebookRestrictions that) {
		...
		boolean this_present_noSendMessageToRecipients = true && this
				.isSetNoSendMessageToRecipients();
		boolean that_present_noSendMessageToRecipients = true && that
				.isSetNoSendMessageToRecipients();
		...
		boolean this_present_noPublishToBusinessLibrary = true && this
				.isSetNoPublishToBusinessLibrary();
		boolean that_present_noPublishToBusinessLibrary = true && that
				.isSetNoPublishToBusinessLibrary();
		...
		boolean this_present_updateWhichSharedNotebookRestrictions = true && this
				.isSetUpdateWhichSharedNotebookRestrictions();
		boolean that_present_updateWhichSharedNotebookRestrictions = true && that
				.isSetUpdateWhichSharedNotebookRestrictions();
		if (this_present_updateWhichSharedNotebookRestrictions
				|| that_present_updateWhichSharedNotebookRestrictions) {
			if (!(this_present_updateWhichSharedNotebookRestrictions && that_present_updateWhichSharedNotebookRestrictions)) {
				return false;
			}
			if (!this.updateWhichSharedNotebookRestrictions
					.equals(that.updateWhichSharedNotebookRestrictions)) {
				return false;
			}
		}

		boolean this_present_expungeWhichSharedNotebookRestrictions = true && this
				.isSetExpungeWhichSharedNotebookRestrictions();
		boolean that_present_expungeWhichSharedNotebookRestrictions = true && that
				.isSetExpungeWhichSharedNotebookRestrictions();
		if (this_present_expungeWhichSharedNotebookRestrictions
				|| that_present_expungeWhichSharedNotebookRestrictions) {
			if (!(this_present_expungeWhichSharedNotebookRestrictions && that_present_expungeWhichSharedNotebookRestrictions)) {
				return false;
			}
			if (!this.expungeWhichSharedNotebookRestrictions
					.equals(that.expungeWhichSharedNotebookRestrictions)) {
				return false;
			}
		}
	...
	public int compareTo(NotebookRestrictions other) {
		...
		NotebookRestrictions typedOther = other;

		lastComparison = Boolean.valueOf(isSetNoReadNotes()).compareTo(
				typedOther.isSetNoReadNotes());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoReadNotes()) {
			lastComparison = TBaseHelper.compareTo(this.noReadNotes, typedOther.noReadNotes);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoCreateNotes()).compareTo(
				typedOther.isSetNoCreateNotes());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoCreateNotes()) {
			lastComparison = TBaseHelper.compareTo(this.noCreateNotes, typedOther.noCreateNotes);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoUpdateNotes()).compareTo(
				typedOther.isSetNoUpdateNotes());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoUpdateNotes()) {
			lastComparison = TBaseHelper.compareTo(this.noUpdateNotes, typedOther.noUpdateNotes);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoExpungeNotes()).compareTo(
				typedOther.isSetNoExpungeNotes());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoExpungeNotes()) {
			lastComparison = TBaseHelper.compareTo(this.noExpungeNotes, typedOther.noExpungeNotes);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoShareNotes()).compareTo(
				typedOther.isSetNoShareNotes());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoShareNotes()) {
			lastComparison = TBaseHelper.compareTo(this.noShareNotes, typedOther.noShareNotes);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoEmailNotes()).compareTo(
				typedOther.isSetNoEmailNotes());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoEmailNotes()) {
			lastComparison = TBaseHelper.compareTo(this.noEmailNotes, typedOther.noEmailNotes);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoSendMessageToRecipients()).compareTo(
				typedOther.isSetNoSendMessageToRecipients());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoSendMessageToRecipients()) {
			lastComparison = TBaseHelper.compareTo(this.noSendMessageToRecipients,
					typedOther.noSendMessageToRecipients);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoUpdateNotebook()).compareTo(
				typedOther.isSetNoUpdateNotebook());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoUpdateNotebook()) {
			lastComparison = TBaseHelper.compareTo(this.noUpdateNotebook,
					typedOther.noUpdateNotebook);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoExpungeNotebook()).compareTo(
				typedOther.isSetNoExpungeNotebook());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoExpungeNotebook()) {
			lastComparison = TBaseHelper.compareTo(this.noExpungeNotebook,
					typedOther.noExpungeNotebook);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoSetDefaultNotebook()).compareTo(
				typedOther.isSetNoSetDefaultNotebook());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoSetDefaultNotebook()) {
			lastComparison = TBaseHelper.compareTo(this.noSetDefaultNotebook,
					typedOther.noSetDefaultNotebook);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoSetNotebookStack()).compareTo(
				typedOther.isSetNoSetNotebookStack());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoSetNotebookStack()) {
			lastComparison = TBaseHelper.compareTo(this.noSetNotebookStack,
					typedOther.noSetNotebookStack);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoPublishToPublic()).compareTo(
				typedOther.isSetNoPublishToPublic());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoPublishToPublic()) {
			lastComparison = TBaseHelper.compareTo(this.noPublishToPublic,
					typedOther.noPublishToPublic);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoPublishToBusinessLibrary()).compareTo(
				typedOther.isSetNoPublishToBusinessLibrary());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoPublishToBusinessLibrary()) {
			lastComparison = TBaseHelper.compareTo(this.noPublishToBusinessLibrary,
					typedOther.noPublishToBusinessLibrary);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoCreateTags()).compareTo(
				typedOther.isSetNoCreateTags());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoCreateTags()) {
			lastComparison = TBaseHelper.compareTo(this.noCreateTags, typedOther.noCreateTags);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoUpdateTags()).compareTo(
				typedOther.isSetNoUpdateTags());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoUpdateTags()) {
			lastComparison = TBaseHelper.compareTo(this.noUpdateTags, typedOther.noUpdateTags);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoExpungeTags()).compareTo(
				typedOther.isSetNoExpungeTags());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoExpungeTags()) {
			lastComparison = TBaseHelper.compareTo(this.noExpungeTags, typedOther.noExpungeTags);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoSetParentTag()).compareTo(
				typedOther.isSetNoSetParentTag());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoSetParentTag()) {
			lastComparison = TBaseHelper.compareTo(this.noSetParentTag, typedOther.noSetParentTag);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNoCreateSharedNotebooks()).compareTo(
				typedOther.isSetNoCreateSharedNotebooks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNoCreateSharedNotebooks()) {
			lastComparison = TBaseHelper.compareTo(this.noCreateSharedNotebooks,
					typedOther.noCreateSharedNotebooks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetUpdateWhichSharedNotebookRestrictions()).compareTo(
				typedOther.isSetUpdateWhichSharedNotebookRestrictions());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetUpdateWhichSharedNotebookRestrictions()) {
			lastComparison = TBaseHelper.compareTo(this.updateWhichSharedNotebookRestrictions,
					typedOther.updateWhichSharedNotebookRestrictions);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetExpungeWhichSharedNotebookRestrictions()).compareTo(
				typedOther.isSetExpungeWhichSharedNotebookRestrictions());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetExpungeWhichSharedNotebookRestrictions()) {
			lastComparison = TBaseHelper.compareTo(this.expungeWhichSharedNotebookRestrictions,
					typedOther.expungeWhichSharedNotebookRestrictions);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
