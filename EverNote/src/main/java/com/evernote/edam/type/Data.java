...
public class Data implements TBase<Data>, java.io.Serializable, Cloneable {
	...
	private static final TField BODY_HASH_FIELD_DESC = new TField("bodyHash", TType.STRING,
			(short) 1);
	...
	public int compareTo(Data other) {
		...
		if (isSetBodyHash()) {
			lastComparison = TBaseHelper.compareTo(this.bodyHash, typedOther.bodyHash);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
