...
public class Accounting implements TBase<Accounting>, java.io.Serializable, Cloneable {
	...
	private static final TField UPLOAD_LIMIT_FIELD_DESC = new TField("uploadLimit", TType.I64,
			(short) 1);
	private static final TField UPLOAD_LIMIT_END_FIELD_DESC = new TField("uploadLimitEnd",
			TType.I64, (short) 2);
	private static final TField UPLOAD_LIMIT_NEXT_MONTH_FIELD_DESC = new TField(
			"uploadLimitNextMonth", TType.I64, (short) 3);
	private static final TField PREMIUM_SERVICE_STATUS_FIELD_DESC = new TField(
			"premiumServiceStatus", TType.I32, (short) 4);
	private static final TField PREMIUM_ORDER_NUMBER_FIELD_DESC = new TField("premiumOrderNumber",
			TType.STRING, (short) 5);
	private static final TField PREMIUM_COMMERCE_SERVICE_FIELD_DESC = new TField(
			"premiumCommerceService", TType.STRING, (short) 6);
	private static final TField PREMIUM_SERVICE_START_FIELD_DESC = new TField(
			"premiumServiceStart", TType.I64, (short) 7);
	private static final TField PREMIUM_SERVICE_SKU_FIELD_DESC = new TField("premiumServiceSKU",
			TType.STRING, (short) 8);
	private static final TField LAST_SUCCESSFUL_CHARGE_FIELD_DESC = new TField(
			"lastSuccessfulCharge", TType.I64, (short) 9);
	private static final TField LAST_FAILED_CHARGE_FIELD_DESC = new TField("lastFailedCharge",
			TType.I64, (short) 10);
	private static final TField LAST_FAILED_CHARGE_REASON_FIELD_DESC = new TField(
			"lastFailedChargeReason", TType.STRING, (short) 11);
	private static final TField NEXT_PAYMENT_DUE_FIELD_DESC = new TField("nextPaymentDue",
			TType.I64, (short) 12);
	private static final TField PREMIUM_LOCK_UNTIL_FIELD_DESC = new TField("premiumLockUntil",
			TType.I64, (short) 13);
	private static final TField UPDATED_FIELD_DESC = new TField("updated", TType.I64, (short) 14);
	private static final TField PREMIUM_SUBSCRIPTION_NUMBER_FIELD_DESC = new TField(
			"premiumSubscriptionNumber", TType.STRING, (short) 16);
	private static final TField LAST_REQUESTED_CHARGE_FIELD_DESC = new TField(
			"lastRequestedCharge", TType.I64, (short) 17);
	private static final TField CURRENCY_FIELD_DESC = new TField("currency", TType.STRING,
			(short) 18);
	private static final TField UNIT_PRICE_FIELD_DESC = new TField("unitPrice", TType.I32,
			(short) 19);
	private static final TField BUSINESS_ID_FIELD_DESC = new TField("businessId", TType.I32,
			(short) 20);
	private static final TField BUSINESS_NAME_FIELD_DESC = new TField("businessName", TType.STRING,
			(short) 21);
	private static final TField BUSINESS_ROLE_FIELD_DESC = new TField("businessRole", TType.I32,
			(short) 22);
	private static final TField UNIT_DISCOUNT_FIELD_DESC = new TField("unitDiscount", TType.I32,
			(short) 23);
	private static final TField NEXT_CHARGE_DATE_FIELD_DESC = new TField("nextChargeDate",
			TType.I64, (short) 24);
	...
	private final boolean[] __isset_vector = new boolean[14];
	...
	public boolean equals(Accounting that) {
		...
		boolean this_present_premiumSubscriptionNumber = true && this
				.isSetPremiumSubscriptionNumber();
		boolean that_present_premiumSubscriptionNumber = true && that
				.isSetPremiumSubscriptionNumber();
	...
	public int compareTo(Accounting other) {
		...
		Accounting typedOther = other;

		lastComparison = Boolean.valueOf(isSetUploadLimit()).compareTo(
				typedOther.isSetUploadLimit());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetUploadLimit()) {
			lastComparison = TBaseHelper.compareTo(this.uploadLimit, typedOther.uploadLimit);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetUploadLimitEnd()).compareTo(
				typedOther.isSetUploadLimitEnd());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetUploadLimitEnd()) {
			lastComparison = TBaseHelper.compareTo(this.uploadLimitEnd, typedOther.uploadLimitEnd);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetUploadLimitNextMonth()).compareTo(
				typedOther.isSetUploadLimitNextMonth());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetUploadLimitNextMonth()) {
			lastComparison = TBaseHelper.compareTo(this.uploadLimitNextMonth,
					typedOther.uploadLimitNextMonth);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumServiceStatus()).compareTo(
				typedOther.isSetPremiumServiceStatus());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumServiceStatus()) {
			lastComparison = TBaseHelper.compareTo(this.premiumServiceStatus,
					typedOther.premiumServiceStatus);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumOrderNumber()).compareTo(
				typedOther.isSetPremiumOrderNumber());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumOrderNumber()) {
			lastComparison = TBaseHelper.compareTo(this.premiumOrderNumber,
					typedOther.premiumOrderNumber);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumCommerceService()).compareTo(
				typedOther.isSetPremiumCommerceService());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumCommerceService()) {
			lastComparison = TBaseHelper.compareTo(this.premiumCommerceService,
					typedOther.premiumCommerceService);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumServiceStart()).compareTo(
				typedOther.isSetPremiumServiceStart());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumServiceStart()) {
			lastComparison = TBaseHelper.compareTo(this.premiumServiceStart,
					typedOther.premiumServiceStart);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumServiceSKU()).compareTo(
				typedOther.isSetPremiumServiceSKU());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumServiceSKU()) {
			lastComparison = TBaseHelper.compareTo(this.premiumServiceSKU,
					typedOther.premiumServiceSKU);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetLastSuccessfulCharge()).compareTo(
				typedOther.isSetLastSuccessfulCharge());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLastSuccessfulCharge()) {
			lastComparison = TBaseHelper.compareTo(this.lastSuccessfulCharge,
					typedOther.lastSuccessfulCharge);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetLastFailedCharge()).compareTo(
				typedOther.isSetLastFailedCharge());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLastFailedCharge()) {
			lastComparison = TBaseHelper.compareTo(this.lastFailedCharge,
					typedOther.lastFailedCharge);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetLastFailedChargeReason()).compareTo(
				typedOther.isSetLastFailedChargeReason());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLastFailedChargeReason()) {
			lastComparison = TBaseHelper.compareTo(this.lastFailedChargeReason,
					typedOther.lastFailedChargeReason);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNextPaymentDue()).compareTo(
				typedOther.isSetNextPaymentDue());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNextPaymentDue()) {
			lastComparison = TBaseHelper.compareTo(this.nextPaymentDue, typedOther.nextPaymentDue);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumLockUntil()).compareTo(
				typedOther.isSetPremiumLockUntil());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumLockUntil()) {
			lastComparison = TBaseHelper.compareTo(this.premiumLockUntil,
					typedOther.premiumLockUntil);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetUpdated()) {
			lastComparison = TBaseHelper.compareTo(this.updated, typedOther.updated);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPremiumSubscriptionNumber()).compareTo(
				typedOther.isSetPremiumSubscriptionNumber());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPremiumSubscriptionNumber()) {
			lastComparison = TBaseHelper.compareTo(this.premiumSubscriptionNumber,
					typedOther.premiumSubscriptionNumber);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetLastRequestedCharge()).compareTo(
				typedOther.isSetLastRequestedCharge());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLastRequestedCharge()) {
			lastComparison = TBaseHelper.compareTo(this.lastRequestedCharge,
					typedOther.lastRequestedCharge);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetCurrency()) {
			lastComparison = TBaseHelper.compareTo(this.currency, typedOther.currency);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetUnitPrice()) {
			lastComparison = TBaseHelper.compareTo(this.unitPrice, typedOther.unitPrice);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetBusinessId()) {
			lastComparison = TBaseHelper.compareTo(this.businessId, typedOther.businessId);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetBusinessName()).compareTo(
				typedOther.isSetBusinessName());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetBusinessName()) {
			lastComparison = TBaseHelper.compareTo(this.businessName, typedOther.businessName);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetBusinessRole()).compareTo(
				typedOther.isSetBusinessRole());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetBusinessRole()) {
			lastComparison = TBaseHelper.compareTo(this.businessRole, typedOther.businessRole);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetUnitDiscount()).compareTo(
				typedOther.isSetUnitDiscount());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetUnitDiscount()) {
			lastComparison = TBaseHelper.compareTo(this.unitDiscount, typedOther.unitDiscount);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetNextChargeDate()).compareTo(
				typedOther.isSetNextChargeDate());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNextChargeDate()) {
			lastComparison = TBaseHelper.compareTo(this.nextChargeDate, typedOther.nextChargeDate);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
