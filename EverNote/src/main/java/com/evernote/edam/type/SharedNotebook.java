...
public class SharedNotebook implements TBase<SharedNotebook>, java.io.Serializable, Cloneable {
	...
	private static final TField NOTEBOOK_GUID_FIELD_DESC = new TField("notebookGuid", TType.STRING,
			(short) 3);
	private static final TField EMAIL_FIELD_DESC = new TField("email", TType.STRING, (short) 4);
	private static final TField NOTEBOOK_MODIFIABLE_FIELD_DESC = new TField("notebookModifiable",
			TType.BOOL, (short) 5);
	private static final TField REQUIRE_LOGIN_FIELD_DESC = new TField("requireLogin", TType.BOOL,
			(short) 6);
	...
	private static final TField USERNAME_FIELD_DESC = new TField("username", TType.STRING,
			(short) 9);
	private static final TField PRIVILEGE_FIELD_DESC = new TField("privilege", TType.I32,
			(short) 11);
	private static final TField ALLOW_PREVIEW_FIELD_DESC = new TField("allowPreview", TType.BOOL,
			(short) 12);
	private static final TField RECIPIENT_SETTINGS_FIELD_DESC = new TField("recipientSettings",
			TType.STRUCT, (short) 13);
	...
	private final boolean[] __isset_vector = new boolean[7];
	...
	public int compareTo(SharedNotebook other) {
		...
		SharedNotebook typedOther = other;
		...
		lastComparison = Boolean.valueOf(isSetNotebookModifiable()).compareTo(
				typedOther.isSetNotebookModifiable());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetNotebookModifiable()) {
			lastComparison = TBaseHelper.compareTo(this.notebookModifiable,
					typedOther.notebookModifiable);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetRequireLogin()).compareTo(
				typedOther.isSetRequireLogin());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetRequireLogin()) {
			lastComparison = TBaseHelper.compareTo(this.requireLogin, typedOther.requireLogin);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		lastComparison = Boolean.valueOf(isSetAllowPreview()).compareTo(
				typedOther.isSetAllowPreview());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetAllowPreview()) {
			lastComparison = TBaseHelper.compareTo(this.allowPreview, typedOther.allowPreview);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
