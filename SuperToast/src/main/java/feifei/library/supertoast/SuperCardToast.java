...
public class SuperCardToast {
	...
	public SuperCardToast(Activity activity) {
		...
		mToastView = mLayoutInflater.inflate(R.layout.supercardtoast,
				mViewGroup, false);
	 ...
	 *            {@link android.app.Activity}
	 * @param style
	 *            {@link feifei.library.supertoast.Style}
	 */
	 ...
	 *            {@link android.app.Activity}
	 * @param type
	 *            {@link feifei.library.supertoast.SuperToast.Type}
	 */
	public SuperCardToast(Activity activity, Type type) {
		...
		if (type == Type.BUTTON) {
			...
			mToastView = mLayoutInflater.inflate(
					R.layout.supercardtoast_button, mViewGroup, false);
			...
			mToastView = mLayoutInflater.inflate(
					R.layout.supercardtoast_progresscircle, mViewGroup, false);
			...
			mToastView = mLayoutInflater.inflate(
					R.layout.supercardtoast_progresshorizontal, mViewGroup,
					false);
	...
	/**
	 * Returns the {@link feifei.library.supertoast.SuperToast.Type} of
	 * {@value #TAG}.
	 * 
	 * @return {@link feifei.library.supertoast.SuperToast.Type}
	 */
	public Type getType() {
	...
	/**
	 * Sets the message {@link android.graphics.Typeface} style of the
	 * {@value #TAG}.
	 * 
	 * @param typeface
	...
	/**
	 * Returns the message {@link android.graphics.Typeface} style of the
	 * {@value #TAG}.
	 * 
	 * @return int
	 */
	 ...
	 * 
	 * @param duration
	 *            {@link feifei.library.supertoast.SuperToast.Duration}
	 */
	 ...
	 * 
	 * @param icon
	 *            {@link feifei.library.supertoast.SuperToast.Icon}
	 * @param iconPosition
	 *            {@link feifei.library.supertoast.SuperToast.IconPosition}
	 */
	...
	public void setIcon(int icon, IconPosition iconPosition) {
		...
		if (iconPosition == IconPosition.BOTTOM) {
			...
			mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(null,
					null, null, mActivity.getResources().getDrawable(icon));

		} else if (iconPosition == IconPosition.LEFT) {

			mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(mActivity
					.getResources().getDrawable(icon), null, null, null);

		} else if (iconPosition == IconPosition.RIGHT) {

			mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(null,
					null, mActivity.getResources().getDrawable(icon), null);
	 ...
	 * 
	 * @return {@link feifei.library.supertoast.SuperToast.IconPosition}
	 */
	...
	/**
	 * Sets the background resource of the {@value #TAG}. The KitKat style
	 * backgrounds included with this library are NOT compatible with
	 * {@value #TAG}.
	 * 
	 * @param background
	 *            {@link feifei.library.supertoast.SuperToast.Background}
	 */
	 ...
	 * 
	 * @param animations
	 *            {@link feifei.library.supertoast.SuperToast.Animations}
	 */
	 ...
	 * 
	 * @return {@link feifei.library.supertoast.SuperToast.Animations}
	 */
	 ...
	 *            {@link feifei.library.supertoast.OnDismissWrapper}
	 */
	...
	private void dismissWithLayoutAnimation() {
		...
		if (mToastView != null) {
			...
			final ViewGroup.LayoutParams layoutParams = mToastView
					.getLayoutParams();
	...
	/**
	 * Sets an OnClickWrapper to the button in a a BUTTON
	 * {@link feifei.library.supertoast.SuperToast.Type} {@value #TAG}.
	 * 
	 * @param onClickWrapper
	 *            {@link feifei.library.supertoast.OnClickWrapper}
	 */
	...
	/**
	 * Returns a standard {@value #TAG}. <br>
	 * IMPORTANT: Activity layout should contain a linear layout with the id
	 * card_container <br>
	 * 
	 * @param activity
	 *            {@link android.app.Activity}
	 ...
	 */
	public static SuperCardToast create(Activity activity,
	...
	/**
	 * Returns a standard {@value #TAG} with specified animations. <br>
	 * IMPORTANT: Activity layout should contain a linear layout with the id
	 * card_container <br>
	 * 
	 * @param activity
	...
	/**
	 * Returns a {@value #TAG} with a specified style. <br>
	 * IMPORTANT: Activity layout should contain a linear layout with the id
	 * card_container <br>
	 * 
	 * @param activity
	...
	public static void onSaveState(Bundle bundle) {
		...
		LinkedList<SuperCardToast> lister = ManagerSuperCardToast.getInstance()
				.getList();
	...
	public static void onRestoreState(Bundle bundle, Activity activity) {
		...
		if (savedArray != null) {
			...
			for (Parcelable parcelable : savedArray) {
				...
				new SuperCardToast(activity, (ReferenceHolder) parcelable,
						null, i);
	 ...
	 *            The current activity
	 * @param wrappers
	 *            {@link feifei.library.supertoast.Wrappers}
	 */
	public static void onRestoreState(Bundle bundle, Activity activity,
			Wrappers wrappers) {
	 ...
	 */
	private SuperCardToast(Activity activity, ReferenceHolder referenceHolder,
			Wrappers wrappers, int position) {
		...
		if (referenceHolder.mType == Type.BUTTON) {
			...
			/*
			 * PROGRESS_HORIZONTAL style SuperCardToasts should be managed by
			 * the developer
			 */
		...
		if (wrappers != null) {
			...
			for (OnDismissWrapper onDismissListenerWrapper : wrappers
					.getOnDismissWrappers()) {

				if (onDismissListenerWrapper.getTag().equalsIgnoreCase(
						referenceHolder.mDismissListenerTag)) {

					superCardToast
							.setOnDismissWrapper(onDismissListenerWrapper);
		...
		superCardToast.setIcon(referenceHolder.mIcon,
	...
	private static class ReferenceHolder implements Parcelable {
		...
		public ReferenceHolder(SuperCardToast superCardToast) {
			...
			if (superCardToast.getIconResource() != 0
					&& superCardToast.getIconPosition() != null) {
