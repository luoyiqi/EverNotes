 ...
 * @date       2014-8-6
 * @date       上午10:47:56
 * @file         ScrollerNumberPicker.java
 * @content  滑动选择
 */
public class ScrollerNumberPicker extends View {
	...
	/** 选择的内容 */
	private final ArrayList<ItemObject> itemList = new ArrayList<ItemObject>();
	/** 设置数据 */
	...
	/** 短促移动 */
	private final long goonTime = 200;
	/** 短促移动距离 */
	private final int goonDistence = 100;
	/** 画线画笔 */
