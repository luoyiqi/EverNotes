package feifei.library.datepicker.time;
...
import feifei.library.datepicker.date.Utils;
...
public class TimePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.picker_time_dialog, null);
        KeyboardListener keyboardListener = new KeyboardListener();
        view.findViewById(R.id.time_picker_dialog).setOnKeyListener(
                keyboardListener);

        Resources res = getResources();
        mHourPickerDescription = "小时转盘";
        mSelectHours = "选择小时";
        mMinutePickerDescription = "分钟转盘";
        mSelectMinutes = "选择分钟";
        mBlue = res.getColor(R.color.lightblue);
     ...
     *
     * @param allowEmptyDisplay if true, then if the typedTimes is empty, use the placeholder
     ...
     * minutes typed.
     *
     * @param enteredZeros A size-2 boolean array, which the caller should initialize,
