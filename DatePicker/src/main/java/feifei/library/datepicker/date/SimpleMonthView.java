...
public class SimpleMonthView extends View {
	...
	public SimpleMonthView(Context context) {
		...
		this.mDayTextColor = resources
				.getColor(R.color.date_picker_text_normal);
	...
	private void drawMonthDayLabels(Canvas canvas) {
		...
		for (int day = 0; day < this.mNumDays; day++) {
			...
			canvas.drawText(
					mDateFormatSymbols.getShortWeekdays()[this.mDayLabelCalendar
	...
	public SimpleMonthAdapter.CalendarDay getDayFromLocation(float x, float y) {
		...
		int day = 1
				+ ((int) ((x - padding) * this.mNumDays / (this.mWidth
