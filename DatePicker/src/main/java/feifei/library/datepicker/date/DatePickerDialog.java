package feifei.library.datepicker.date;
...
public class DatePickerDialog extends DialogFragment implements
	...
	public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent,
		...
		View view = layoutInflater.inflate(R.layout.picker_date_dialog, null);
		...
		this.mDayPickerDescription = "按月份划分的日期网格";
		this.setmSelectDay("选择月份和日期");
		this.mYearPickerDescription = "年份列表";
		this.setmSelectYear("选择年份");
	...
	public void setmSelectYear(String mSelectYear) {
	...
	public void setmSelectDay(String mSelectDay) {
