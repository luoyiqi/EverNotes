...
public class RefreshWebView2 extends RefreshWebView {
	...
	public RefreshWebView2(Context context) {
		super(context);
	}

	public RefreshWebView2(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public RefreshWebView2(Context context, Mode mode) {
		super(context, mode);
	}
