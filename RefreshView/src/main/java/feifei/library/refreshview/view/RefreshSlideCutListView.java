...
import feifei.library.refreshview.base.EmptyViewMethodAccessor;
...
//外层得放LinearLayout才行
public class RefreshSlideCutListView extends RefreshAdapterViewBase<SlideCutListView> {
	...
	public RefreshSlideCutListView (Context context) {
		super(context);
	}

	public RefreshSlideCutListView (Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public RefreshSlideCutListView (Context context, Mode mode) {
		super(context, mode);
	}

	public RefreshSlideCutListView (Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy (RefreshSlideCutListView.this, deltaX,
					scrollX, deltaY, scrollY, isTouchEvent);
			return returnValue;
		}
	}

	protected class InternalListView extends SlideCutListView implements
		...
		public void setEmptyView(View emptyView) {
			RefreshSlideCutListView.this.setEmptyView(emptyView);
		}
