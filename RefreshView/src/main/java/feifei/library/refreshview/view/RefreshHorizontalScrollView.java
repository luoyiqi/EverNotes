...
public class RefreshHorizontalScrollView extends
		RefreshBase<HorizontalScrollView> {

	public RefreshHorizontalScrollView(Context context) {
		super(context);
	}

	public RefreshHorizontalScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public RefreshHorizontalScrollView(Context context, Mode mode) {
		super(context, mode);
	}
	...
	final class InternalHorizontalScrollViewSDK9 extends HorizontalScrollView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy (RefreshHorizontalScrollView.this,
