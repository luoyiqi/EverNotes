...
public class RefreshExpandableListView extends
		RefreshAdapterViewBase<ExpandableListView> {
	...
	public RefreshExpandableListView(Context context, Mode mode) {
		super(context, mode);
	}
	...
	class InternalExpandableListView extends ExpandableListView implements
		...
		public void setEmptyView(View emptyView) {
			RefreshExpandableListView.this.setEmptyView(emptyView);
		}
	...
	final class InternalExpandableListViewSDK9 extends
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy (RefreshExpandableListView.this,
