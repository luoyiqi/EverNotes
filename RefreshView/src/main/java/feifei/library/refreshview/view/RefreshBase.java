...
import feifei.library.refreshview.R;
import feifei.library.refreshview.base.FlipLoadingLayout;
import feifei.library.refreshview.base.ILoadingLayout;
import feifei.library.refreshview.base.IPullToRefresh;
import feifei.library.refreshview.base.LoadingLayout;
import feifei.library.refreshview.base.LoadingLayoutProxy;
import feifei.library.refreshview.base.OverscrollHelper;
import feifei.library.refreshview.base.RotateLoadingLayout;
import feifei.library.refreshview.base.Utils;
import feifei.library.refreshview.base.ViewCompat;
...
public abstract class RefreshBase<T extends View> extends LinearLayout
    ...
    private Mode lastMode = Mode.getDefault ();
    ...
    public RefreshBase (Context context, Mode mode) {
        super (context);
        mMode = mode;
        init (context, null);
    }

    public RefreshBase (Context context, Mode mode, AnimationStyle animStyle) {
        super (context);
        mMode = mode;
    ...
    public final void setPullToRefreshEnabled (boolean enable) {
        ...
        // setMode(enable ? lastMode : Mode.DISABLED);
    }
     ...
     * {@link RefreshAdapterViewBase#setOnLastItemVisibleListener}.
     *
     * @author Chris Banes
     */
     ...
     * (such as sounds). See (
     * {@link RefreshAdapterViewBase#setOnPullEventListener}.
     *
     * @author Chris Banes
     */
    public static interface OnPullEventListener<V extends View> {
         ...
         */
        public void onPullEvent (final RefreshBase<V> refreshView, State state,
                                 Mode direction);
    ...
    public static interface OnRefreshListener<V extends View> {
         ...
         * end
         */
        public void onRefresh (final RefreshBase<V> refreshView);

    }

    /**
     * 这个监听器里面区分了上下拉进行不同的操作
     */
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run () {
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                ViewCompat.postOnAnimation (RefreshBase.this, this);
            } else {
                if (null != mListener) {
