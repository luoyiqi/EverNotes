 ...
 * 
 */
public class RefreshExpandableListFragment extends RefreshBaseListFragment<RefreshExpandableListView> {

	protected RefreshExpandableListView onCreatePullToRefreshListView(LayoutInflater inflater,
			Bundle savedInstanceState) {
		return new RefreshExpandableListView(getActivity());
	}
