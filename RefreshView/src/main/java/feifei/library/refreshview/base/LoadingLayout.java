package feifei.library.refreshview.base;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public LoadingLayout(Context context, final RefreshBase.Mode mode,
			final RefreshBase.Orientation scrollDirection, TypedArray attrs) {
		super(context);
		mMode = mode;
		...
		case HORIZONTAL:
			LayoutInflater.from(context).inflate(
					R.layout.refresh_header_horizontal, this);
			break;
		case VERTICAL:
		default:
			LayoutInflater.from(context).inflate(
					R.layout.refresh_header_vertical, this);
			break;
		}
		...
		switch (mode) {
		case PULL_FROM_END:
			lp.gravity = scrollDirection == RefreshBase.Orientation.VERTICAL ? Gravity.TOP
					: Gravity.LEFT;
		...
		default:
			lp.gravity = scrollDirection == RefreshBase.Orientation.VERTICAL ? Gravity.BOTTOM
					: Gravity.RIGHT;
		...
		// 在这里设置字体颜色
		mHeaderText.setTextColor(Color.parseColor("#ff005092"));
		mSubHeaderText.setTextColor(Color.parseColor("#ff005092"));
