...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, RefreshBase.Mode mode) {
		super(context);
		...
		case PULL_FROM_END:
			...
			setBackgroundResource(R.drawable.refresh_bottom);
		...
		case PULL_FROM_START:
			...
			setBackgroundResource(R.drawable.refresh_top);
			break;
		}
