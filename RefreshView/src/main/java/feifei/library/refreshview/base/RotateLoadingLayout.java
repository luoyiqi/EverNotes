...
public class RotateLoadingLayout extends LoadingLayout {
	...
	public RotateLoadingLayout(Context context, RefreshBase.Mode mode,
			RefreshBase.Orientation scrollDirection, TypedArray attrs) {
	...
	protected int getDefaultDrawableResId() {
		return R.drawable.refresh_rotate;
	}
