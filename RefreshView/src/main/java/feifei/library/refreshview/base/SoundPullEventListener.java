...
public class SoundPullEventListener<V extends View> implements
		RefreshBase.OnPullEventListener<V> {

	private final Context mContext;
	private final HashMap<RefreshBase.State, Integer> mSoundMap;
	...
	public SoundPullEventListener(Context context) {
		mContext = context;
		mSoundMap = new HashMap<RefreshBase.State, Integer>();
	}

	@Override
	public final void onPullEvent(RefreshBase<V> refreshView, RefreshBase.State event,
			RefreshBase.Mode direction) {
	 ...
	 */
	public void addSoundEvent(RefreshBase.State event, int resId) {
