...
public interface IPullToRefresh<T extends View> {
	 ...
	 */
	public RefreshBase.Mode getCurrentMode();
	 ...
	 */
	public RefreshBase.Mode getMode();
	 ...
	 */
	public RefreshBase.State getState();
	 ...
	 */
	public void setMode(RefreshBase.Mode mode);
	 ...
	 *            propogate.
	 */
	public void setOnPullEventListener(RefreshBase.OnPullEventListener<T> listener);
	 ...
	 */
	public void setOnRefreshListener(RefreshBase.OnRefreshListener<T> listener);
	 ...
	 *            - Listener to be used when the Widget is set to Refresh
	 */
	public void setOnRefreshListener(RefreshBase.OnRefreshListener2<T> listener);
